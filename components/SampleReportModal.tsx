...
const SERVICE_PROVIDERS: Record<string, TranslationMap> = {
  ...
  de: {
    lt: 'BMW servisas, Vokietija',
    en: 'BMW Service, Germany',
    de: 'BMW Service, Deutschland',
    pl: 'Serwis BMW, Niemcy',
    fr: 'Service BMW, Allemagne',
    es: 'Servicio BMW, Alemania',
  },
  lt: {
    lt: 'Ozas, Vilnius',
...
const SERVICE_EVENTS_2 = [
  ...
  { date: '2022-07-21', mileage: 190943, providerKey: 'lt', type: 'service', actionKeys: ['Engine oil.', 'Fuel filter.', 'Air filter element.', 'Vehicle check.', 'Microfilter (consider further additional job(s) if appropriate).'] },
  { date: '2022-01-21', mileage: 174360, providerKey: 'lt', type: 'service', actionKeys: ['Front Brake.'] },
  { date: '2021-03-03', mileage: 168257, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2020-11-04', mileage: 159844, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2020-10-05', mileage: 156796, providerKey: 'de', type: 'service', actionKeys: [] },
  { date: '2020-10-05', mileage: 156790, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.', 'Rear Brake.', 'Fuel filter.', 'Air filter element.', 'Vehicle check.', 'Microfilter (consider further additional job(s) if appropriate).'] },
  { date: '2020-08-06', mileage: 150689, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2020-07-16', mileage: 147702, providerKey: 'de', type: 'service', actionKeys: ['Brake fluid service.'] },
  { date: '2020-07-01', mileage: 146282, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2020-05-06', mileage: 142769, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2020-04-27', mileage: 141681, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2020-01-03', mileage: 130973, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.', 'Microfilter (consider further additional job(s) if appropriate).'] },
  { date: '2019-10-16', mileage: 120000, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2019-10-04', mileage: 116112, providerKey: 'de', type: 'service', actionKeys: ['Front Brake.'] },
  { date: '2019-09-30', mileage: 115018, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2019-07-16', mileage: 105202, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2019-07-16', mileage: 105222, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.'] },
  { date: '2019-07-08', mileage: 104147, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.', 'Rear Brake.', 'Fuel filter.', 'Air filter element.', 'Vehicle check.', 'Microfilter (consider further additional job(s) if appropriate).'] },
  { date: '2019-04-26', mileage: 93008, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2019-03-28', mileage: 88119, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2019-03-18', mileage: 88119, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2019-02-01', mileage: 82634, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2019-01-18', mileage: 80297, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2019-01-18', mileage: 80291, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.', 'Microfilter (consider further additional job(s) if appropriate).'] },
  { date: '2019-01-16', mileage: 80036, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2018-12-08', mileage: 26457, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.'] },
  { date: '2018-11-05', mileage: 70500, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2018-07-24', mileage: 57603, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2018-07-24', mileage: 57532, providerKey: 'de', type: 'service', actionKeys: ['Front Brake.'] },
  { date: '2018-06-21', mileage: 52275, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.', 'Rear Brake.', 'Fuel filter.', 'Air filter element.', 'Vehicle check.', 'Microfilter (consider further additional job(s) if appropriate).'] },
  { date: '2018-06-01', mileage: 48293, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2018-04-13', mileage: 42506, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2018-04-06', mileage: 41573, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2018-04-04', mileage: 41268, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2018-04-03', mileage: 41057, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2018-01-17', mileage: 26457, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.'] },
  { date: '2018-01-08', mileage: 26451, providerKey: 'de', type: 'service', actionKeys: ['Engine oil.', 'Microfilter (consider further additional job(s) if appropriate).'] },
  { date: '2018-01-08', mileage: 26457, providerKey: 'de', type: 'service', actionKeys: [] },
  { date: '2018-01-04', mileage: 26269, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2017-11-08', mileage: 17533, providerKey: null, type: 'service', actionKeys: [] },
  { date: '2017-10-26', mileage: 17533, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
  { date: '2017-07-07', mileage: 12, providerKey: 'de', type: 'service', actionKeys: [] },
  { date: '2017-07-07', mileage: 3, providerKey: 'de', type: 'service', actionKeys: ['unknown.'] },
];
