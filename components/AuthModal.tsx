...
const AuthModal: React.FC<AuthModalProps> = ({ open, onClose, t }) => {
  ...
  const handleFacebookLogin = async () => {
    ...
    try {
      ...
      setError(t.auth?.facebookError || 'Facebook login failed');
    }
    setLoading(false);
  };
  ...
  return (
<div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm overflow-y-auto" onClick={handleClose}>
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#1877F2] hover:bg-[#166FE5] border-0 rounded-2xl font-bold text-white transition-all disabled:opacity-60"
                >
