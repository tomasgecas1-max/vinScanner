...
const translationsMap: Record<SupportedLang, Translations> = {
  ...
  pl: {
    ...
    hero: { title: 'Poznaj historię pojazdu', titleAccent: 'według numeru VIN', desc: 'Sprawdź historię przebiegu i zapisy serwisowe w zaledwie kilka sekund. Profesjonalna weryfikacja dostępna dla każdego.', placeholder: 'Wpisz numer VIN...', button: 'Sprawdź', sample: 'Przykładowy raport' },
