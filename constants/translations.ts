...
export interface Translations {
  ...
  pricing: {
    ...
    /** Banneris: „Papildoma {percent}% nuolaida bus pritaikyta atsiskaitant“ */
...
const translationsMap: Record<SupportedLang, Translations> = {
  lt: {
    ...
    nav: { services: 'Paslaugos', pricing: 'Kainos', sampleReport: 'Pavyzdinė ataskaita', settings: 'Nustatymai', login: 'Prisijungti', myReports: 'Mano ataskaitos', signOut: 'Atsijungti', deleteAccount: 'Ištrinti paskyrą', deleteAccountConfirm: 'Ištrinti paskyrą', deleteAccountConfirmText: 'Ar tikrai norite ištrinti paskyrą? Visi išsaugoti ataskaitos bus pašalinti. Šio veiksmo negalima atšaukti.', deleteAccountDeleting: 'Trinama…', deleteAccountError: 'Nepavyko ištrinti. Bandykite dar kartą.' },
    tokenMode: {
    ...
    hero: {
      ...
      desc: 'Patikrinkite ridos istoriją ir serviso įrašus vos per kelias sekundes. Profesionali patikra prieinama kiekvienam.',
      placeholder: 'Įveskite VIN numerį...',
      button: 'Tikrinti',
      sample: 'Pavyzdinė ataskaita',
      getDiscountCode: 'Gauti nuolaidos kodą',
    },
    discountWheel: {
      title: 'Suk ir gauk papildomą nuolaidą!',
      getExtraDiscountButton: 'Gauti papildomą nuolaidą!',
      spin: 'Sukasi...',
      spinButton: 'Sukti',
      spinsOfThree: 'iš 3 sukimų',
    ...
    pricing: {
      ...
      desc: 'Jei jūsų ataskaitose nebus rasta ridos fiksavimo duomenų, ši ataskaita jums nieko nekainuos',
      ...
      orderStepAgreeTerms: 'Sutinku su naudojimo sąlygomis ir perskaičiau privatumo politiką',
      orderStepAgreeBeforeTerms: 'Sutinku su ',
      orderStepTermsLink: 'naudojimo sąlygomis',
      ...
      discountBannerMessage: 'Papildoma {percent}% nuolaida bus pritaikyta atsiskaitant',
    ...
    footer: {
      ...
      usageInstructionsLink: 'Naudojimo sąlygos',
    },
    about: {
      title: 'Apie mus',
    ...
    features: {
      ...
      theftCheckDesc: 'Tikriname duomenų bazes, ar automobilis nebuvo vogtas.',
    },
    report: {
      ...
      damageLabel: 'Žala:',
      translateReportWithGemini: 'Versti ataskaitą',
      translatingReport: 'Vyksta automatinis ataskaitos vertimas',
      ...
      titleBrandTranslating: 'Vyksta vertimas…',
      ...
      aiInsightsDesc: 'AI automatiškai analizuoja ataskaitą ir pateikia santrauką su svarbiausiais įrašais.',
  ...
  en: {
    ...
    hero: {
      ...
      desc: 'Check mileage history and service records in just a few seconds. Professional verification available for everyone.',
    ...
    discountWheel: {
      title: 'Spin and get an extra discount!',
      getExtraDiscountButton: 'Get extra discount!',
      spin: 'Spinning...',
      spinButton: 'Spin',
      spinsOfThree: 'of 3 spins',
      codeLabel: 'Your discount code',
      applyDiscount: 'Apply discount',
      close: 'Close',
      nextSpinTomorrow: 'Next spin available tomorrow.',
    },
    pricing: {
      title: 'Choose the right plan for you',
      desc: 'If no mileage recording data is found in your reports, this report will cost you nothing',
      descHighlight: 'nothing',
      ...
      orderStepAgreeTerms: 'I agree to the terms of use and have read the privacy policy',
      orderStepAgreeBeforeTerms: 'I agree to the ',
      orderStepTermsLink: 'terms of use',
      ...
      discountBannerMessage: 'Additional {percent}% discount will be applied at checkout',
    ...
    footer: {
      ...
      usageInstructionsLink: 'Terms of Service',
    },
    about: {
      title: 'About Us',
    ...
    features: {
      ...
      theftCheckDesc: 'We check databases to see if the vehicle was stolen.',
    },
    report: {
      ...
      damageLabel: 'Damage:',
      translateReportWithGemini: 'Translate report',
      translatingReport: 'Automatic report translation in progress',
      ...
      titleBrandTranslating: 'Translating…',
      ...
      aiInsightsDesc: "AI automatically analyzes the report and provides a summary with the most important findings.",
      analyzing: 'Analyzing…',
  ...
  de: {
    ...
    nav: { services: 'Leistungen', pricing: 'Preise', sampleReport: 'Musterbericht', settings: 'Einstellungen', login: 'Anmelden', myReports: 'Meine Berichte', signOut: 'Abmelden', deleteAccount: 'Konto löschen', deleteAccountConfirm: 'Konto löschen', deleteAccountConfirmText: 'Sind Sie sicher, dass Sie Ihr Konto löschen möchten? Alle gespeicherten Berichte werden entfernt. Diese Aktion kann nicht rückgängig gemacht werden.', deleteAccountDeleting: 'Wird gelöscht…', deleteAccountError: 'Löschen fehlgeschlagen. Bitte versuchen Sie es erneut.' },
    tokenMode: {
    ...
    hero: {
      ...
      desc: 'Prüfen Sie Kilometerstand und Serviceregister in nur wenigen Sekunden. Professionelle Verifizierung für jeden.',
      placeholder: 'FIN-Nummer eingeben...',
      button: 'Prüfen',
      sample: 'Musterbericht',
      getDiscountCode: 'Rabattcode erhalten',
    },
    discountWheel: {
      title: 'Drehen Sie und erhalten Sie einen zusätzlichen Rabatt!',
      getExtraDiscountButton: 'Zusätzlichen Rabatt erhalten!',
      spin: 'Dreht sich...',
      spinButton: 'Drehen',
      spinsOfThree: 'von 3 Drehungen',
      codeLabel: 'Ihr Rabattcode',
      applyDiscount: 'Rabatt anwenden',
      close: 'Schließen',
      nextSpinTomorrow: 'Nächstes Drehen morgen möglich.',
    },
    pricing: {
      title: 'Wählen Sie den richtigen Plan',
      desc: 'Wenn in Ihren Berichten keine Kilometerstandsdaten gefunden werden, kostet Sie dieser Bericht nichts',
      descHighlight: 'nichts',
      ...
      orderStepTermsLink: 'Nutzungsbedingungen',
      ...
      discountBannerMessage: 'Zusätzlicher {percent}% Rabatt wird an der Kasse angewendet',
    ...
    footer: {
      ...
      usageInstructionsLink: 'Nutzungsbedingungen',
    },
    about: {
      title: 'Über uns',
    ...
    features: {
      ...
      theftCheckDesc: 'Wir prüfen Datenbanken, ob das Fahrzeug gestohlen wurde.',
    },
    report: {
      ...
      damageLabel: 'Schaden:',
      translateReportWithGemini: 'Bericht übersetzen',
      translatingReport: 'Automatische Berichtsübersetzung läuft',
      ...
      titleBrandTranslating: 'Übersetzung läuft…',
  ...
  es: {
    ...
    nav: { services: 'Servicios', pricing: 'Precios', sampleReport: 'Informe de muestra', settings: 'Ajustes', login: 'Iniciar sesión', myReports: 'Mis informes', signOut: 'Cerrar sesión', deleteAccount: 'Eliminar cuenta', deleteAccountConfirm: 'Eliminar cuenta', deleteAccountConfirmText: '¿Está seguro de que desea eliminar su cuenta? Todos los informes guardados serán eliminados. Esta acción no se puede deshacer.', deleteAccountDeleting: 'Eliminando…', deleteAccountError: 'Error al eliminar. Inténtelo de nuevo.' },
    tokenMode: { banner: 'Tiene {n} de {total} informes. Ingrese el VIN abajo.', noReports: 'No quedan informes. Compre un nuevo plan para verificar otro vehículo.', loading: 'Cargando…', error: 'Error al cargar la compra. Verifique el enlace.', confirmationSentToEmail: 'Confirmación y enlace enviados a su correo electrónico.' },
    hero: { title: 'Descubra el historial del vehículo', titleAccent: 'por código VIN', desc: 'Verifique el historial de kilometraje y los registros de servicio en solo unos segundos. Verificación profesional disponible para todos.', placeholder: 'Ingrese el número VIN...', button: 'Verificar', sample: 'Ejemplo de informe' },
    discountWheel: { title: '¡Gira y obtén un descuento extra!', getExtraDiscountButton: '¡Obtener descuento extra!', spin: 'Girando...', spinButton: 'Girar', spinsOfThree: 'de 3 giros', codeLabel: 'Su código de descuento', applyDiscount: 'Aplicar descuento', close: 'Cerrar', nextSpinTomorrow: 'Próximo giro disponible mañana.' },
    pricing: { title: 'Elija el plan adecuado', desc: 'Si no se encuentran datos de kilometraje en sus informes, este informe no le costará nada', descHighlight: 'no le costará nada', bestValue: 'Mejor valor', order: 'Ordenar ahora', confirm: 'Confirmar', selectPlanForVin: 'Seleccione un plan para la verificación VIN', refundPolicy: 'Política de reembolso', perReport: 'Por informe:', orderStepTitle: 'Ingrese su email para los informes', orderStepEmailLabel: 'Dirección de email donde se enviarán los informes', orderStepEmailPlaceholder: 'ejemplo@email.es', orderStepAgreeTerms: 'Acepto los términos y he leído la política de privacidad', orderStepAgreeBeforeTerms: 'Acepto los ', orderStepTermsLink: 'términos', orderStepAgreeBetween: ' y he leído la ', orderStepPrivacyLink: 'política de privacidad', orderStepTermsText: 'Los términos de servicio se mostrarán aquí. Este es un texto temporal – la versión final se añadirá más tarde.', orderStepPrivacyText: 'La política de privacidad se mostrará aquí: cómo recopilamos, almacenamos y usamos sus datos. Esta descripción es temporal – el texto completo se añadirá más tarde.', orderStepContinue: 'Continuar', paymentTitle: 'Pago', paymentOrderSummary: 'Resumen del pedido', paymentPlan: 'Plan', paymentVin: 'VIN', paymentSubtotal: 'Subtotal', paymentDiscount: 'Descuento', paymentTotal: 'Total', paymentDiscountCode: 'Código de descuento', paymentDiscountPlaceholder: 'Ingrese el código', paymentApply: 'Aplicar', paymentPay: 'Pagar', paymentSecure: 'Pago seguro', paymentCodeInvalid: 'Código de descuento inválido', paymentCodeApplied: 'Descuento aplicado', discountBannerMessage: 'Descuento adicional del {percent}% aplicado al pagar', paymentApiUnavailable: 'API de pago no disponible. Localmente ejecute: vercel dev (no npm run dev).', paymentFormLoading: 'Preparando formulario de pago…', paymentOrPayAnotherWay: 'O pague de otra forma', paymentMethod: 'Método de pago', paymentCard: 'Tarjeta', paymentLink: 'Enlace', paymentApplePay: 'Apple Pay', paymentEmail: 'Email', paymentOr: 'o', paymentExpressCheckout: 'Express: Apple Pay, Google Pay (mostrados abajo cuando sea compatible)', planSingle: 'Único', planPopular: 'Más popular', planBestValue: 'Mejor valor', report1: '1 Informe', reports2: '2 Informes', reports3: '3 Informes', refundPolicyText: 'El usuario tiene derecho a retirarse de los Servicios (Informes) dentro de los 30 días posteriores a la fecha de compra, enviando una solicitud por correo electrónico con el número de pedido, fecha y datos de contacto. El reembolso se procesa dentro de los 14 días de recibir la solicitud.\n\nLos reembolsos no aplican si el informe ya se usó para verificar el historial del vehículo o si se usó al menos un informe del paquete comprado.', close: 'Cerrar' },
    footer: { desc: 'Fuente confiable de historial de vehículos en Europa. Nuestra misión es la transparencia en cada kilómetro.', privacyLink: 'Política de privacidad', termsLink: 'Términos de uso', usageInstructionsLink: 'Términos de uso' },
  ...
  it: {
    ...
    nav: { services: 'Servizi', pricing: 'Prezzi', sampleReport: 'Esempio di report', settings: 'Impostazioni', login: 'Accedi', myReports: 'I miei report', signOut: 'Esci', deleteAccount: 'Elimina account', deleteAccountConfirm: 'Elimina account', deleteAccountConfirmText: 'Sei sicuro di voler eliminare il tuo account? Tutti i report salvati verranno rimossi. Questa azione non può essere annullata.', deleteAccountDeleting: 'Eliminazione…', deleteAccountError: 'Eliminazione fallita. Riprova.' },
    tokenMode: { banner: 'Hai {n} di {total} report. Inserisci il VIN qui sotto.', noReports: 'Nessun report rimanente. Acquista un nuovo piano per verificare un altro veicolo.', loading: 'Caricamento…', error: 'Impossibile caricare l\'acquisto. Controlla il link.', confirmationSentToEmail: 'Conferma e link inviati alla tua email.' },
    hero: { title: 'Scopri la storia del veicolo', titleAccent: 'tramite codice VIN', desc: 'Verifica lo storico chilometrico e i registri di servizio in pochi secondi. Il modo più semplice e professionale per verificare la storia di qualsiasi auto.', placeholder: 'Inserisci il numero VIN...', button: 'Verifica', sample: 'Esempio di rapporto' },
    discountWheel: { title: 'Gira e ottieni uno sconto extra!', getExtraDiscountButton: 'Ottieni sconto extra!', spin: 'Gira...', spinButton: 'Gira', spinsOfThree: 'di 3 giri', codeLabel: 'Il tuo codice sconto', applyDiscount: 'Applica sconto', close: 'Chiudi', nextSpinTomorrow: 'Prossimo giro disponibile domani.' },
    pricing: { title: 'Scegli il piano giusto', desc: 'Se nei report non vengono trovati dati di percorrenza, questo report non vi costerà nulla', descHighlight: 'non vi costerà nulla', bestValue: 'Miglior valore', order: 'Ordina ora', confirm: 'Conferma', selectPlanForVin: 'Seleziona un piano per la verifica VIN', refundPolicy: 'Politica di rimborso', perReport: 'Per Rapporto:', orderStepTitle: 'Inserisci l\'email per ricevere i rapporti', orderStepEmailLabel: 'Inserisci l\'indirizzo email dove desideri ricevere i rapporti', orderStepEmailPlaceholder: 'esempio@email.it', orderStepAgreeTerms: 'Accetto i termini e ho letto l\'informativa sulla privacy', orderStepAgreeBeforeTerms: 'Accetto i ', orderStepTermsLink: 'termini', orderStepAgreeBetween: ' e ho letto l\'', orderStepPrivacyLink: 'informativa sulla privacy', orderStepTermsText: 'I termini di servizio verranno visualizzati qui. Questo è un testo provvisorio – la versione finale verrà aggiunta in seguito.', orderStepPrivacyText: 'L\'informativa sulla privacy verrà visualizzata qui: come raccogliamo, conserviamo e utilizziamo i tuoi dati. Questa descrizione è provvisoria – il testo completo verrà aggiunto in seguito.', orderStepContinue: 'Continua', paymentTitle: 'Pagamento', paymentOrderSummary: 'Riepilogo ordine', paymentPlan: 'Piano', paymentVin: 'VIN', paymentSubtotal: 'Subtotale', paymentDiscount: 'Sconto', paymentTotal: 'Totale', paymentDiscountCode: 'Codice sconto', paymentDiscountPlaceholder: 'Inserisci il codice', paymentApply: 'Applica', paymentPay: 'Paga', paymentSecure: 'Pagamento sicuro', paymentCodeInvalid: 'Codice sconto non valido', paymentCodeApplied: 'Sconto applicato', discountBannerMessage: 'Sconto aggiuntivo del {percent}% applicato al checkout', paymentApiUnavailable: 'API di pagamento non disponibile. In locale esegui: vercel dev (non npm run dev).', paymentFormLoading: 'Preparazione modulo di pagamento…', paymentOrPayAnotherWay: 'O paga in altro modo', paymentMethod: 'Metodo di pagamento', paymentCard: 'Carta', paymentLink: 'Link', paymentApplePay: 'Apple Pay', paymentEmail: 'Email', paymentOr: 'o', paymentExpressCheckout: 'Express: Apple Pay, Google Pay (mostrati sotto se supportati)', planSingle: 'Singolo', planPopular: 'Più popolare', planBestValue: 'Miglior valore', report1: '1 Rapporto', reports2: '2 Rapporti', reports3: '3 Rapporti', refundPolicyText: 'L\'utente ha il diritto di recedere dai Servizi (Report) entro 30 giorni dalla data di acquisto, inviando una richiesta via email con numero ordine, data e dati di contatto. Il rimborso viene elaborato entro 14 giorni dalla ricezione della richiesta.\n\nI rimborsi non si applicano se il report è già stato utilizzato per verificare lo storico del veicolo o se è stato utilizzato almeno un report del pacchetto acquistato.', close: 'Chiudi' },
    footer: { desc: 'Fonte affidabile di storia dei veicoli in Europa. La nostra missione è la trasparenza in ogni chilometro.', privacyLink: 'Informativa sulla privacy', termsLink: 'Termini di utilizzo', usageInstructionsLink: 'Termini di utilizzo' },
    about: { title: 'Perché sceglierci', body: 'Vinscanner.eu offre verifiche certificate tramite il numero di telaio (VIN), garantendo trasparenza sulla storia di ogni veicolo. Forniamo report su chilometraggio, danni e valore di mercato per acquistare un\'auto usata con sicurezza.', contactLabel: 'Contattaci:' },
  ...
  cs: {
    ...
    features: { mileageHistory: 'Historie kilometrů', mileageHistoryDesc: 'Analyzujeme data od prodejců a registrů po celé Evropě.', damageRecords: 'Historie servisu', damageRecordsDesc: 'Kontrolujeme záznamy o provedených servisních pracích a údržbě.', theftCheck: 'Kontrola krádeže', theftCheckDesc: 'Kontrolujeme databáze, zda nebylo vozidlo odcizeno.' },
  ...
  uk: {
    ...
    features: { mileageHistory: 'Історія пробігу', mileageHistoryDesc: 'Ми аналізуємо дані від дилерів та реєстрів по всій Європі.', damageRecords: 'Історія обслуговування', damageRecordsDesc: 'Перевіряємо записи про виконані сервісні роботи та технічне обслуговування.', theftCheck: 'Перевірка на викрадення', theftCheckDesc: 'Перевіряємо бази даних, чи не було автомобіль вкрадений.' },
  ...
  sv: {
    ...
    features: { mileageHistory: 'Mätarhistorik', mileageHistoryDesc: 'Vi analyserar data från återförsäljare och register i hela Europa.', damageRecords: 'Servicehistorik', damageRecordsDesc: 'Vi kontrollerar register över utförda servicearbeten och underhåll.', theftCheck: 'Stöldkontroll', theftCheckDesc: 'Vi kontrollerar databaser för att se om fordonet har blivit stulet.' },
  ...
  sr: {
    ...
    nav: { services: 'Услуге', pricing: 'Цене', sampleReport: 'Пример извештаја', settings: 'Подешавања', login: 'Пријава', myReports: 'Моји извештаји', signOut: 'Одјава', deleteAccount: 'Обриши налог', deleteAccountConfirm: 'Обриши налог', deleteAccountConfirmText: 'Да ли сте сигурни да желите да обришете свој налог? Сви сачувани извештаји ће бити уклоњени. Ова радња се не може поништити.', deleteAccountDeleting: 'Брисање…', deleteAccountError: 'Брисање није успело. Покушајте поново.' },
    tokenMode: { banner: 'Имате {n} од {total} извештаја. Унесите VIN испод.', noReports: 'Нема преосталих извештаја. Купите нови план за проверу другог возила.', loading: 'Учитавање…', error: 'Учитавање куповине није успело. Проверите линк.', confirmationSentToEmail: 'Confirmation and link have been sent to your email.' },
    hero: { title: 'Откријте историју возила', titleAccent: 'по VIN коду', desc: 'Проверите историју километраже и сервисне записе за неколико секунди. Професионална верификација доступна свима.', placeholder: 'Унесите VIN број...', button: 'Провери', sample: 'Пример извештаја' },
    discountWheel: { title: 'Окрените и добијте додатни попуст!', spin: 'Окреће се...', spinButton: 'Окрени', spinsOfThree: 'од 3 окретаја', codeLabel: 'Ваш код за попуст', applyDiscount: 'Примени попуст', close: 'Затвори', nextSpinTomorrow: 'Следећи окретај доступан сутра.' },
    pricing: { title: 'Изаберите одговарајући план', desc: 'Ако се у вашим извештајима не нађу подаци о пређеним километрима, овај извештај вам неће ништа коштати', descHighlight: 'ништа', bestValue: 'Најбоља вредност', order: 'Наручи сада', confirm: 'Потврди', selectPlanForVin: 'Изаберите план за VIN проверу', refundPolicy: 'Политика повраћаја', perReport: 'По извештају:', orderStepTitle: 'Унесите имејл за извештаје', orderStepEmailLabel: 'Имејл адреса на коју ће бити послати извештаји', orderStepEmailPlaceholder: 'primer@email.rs', orderStepAgreeTerms: 'Слажем се са условима и прочитао сам политику приватности', orderStepAgreeBeforeTerms: 'Слажем се са ', orderStepTermsLink: 'условима', orderStepAgreeBetween: ' и прочитао сам ', orderStepPrivacyLink: 'политику приватности', orderStepTermsText: 'Овде ће бити приказани услови коришћења. Ово је привремени текст – коначна верзија биће додата касније.', orderStepPrivacyText: 'Овде ће бити приказана политика приватности: како прикупљамо, чувамо и користимо ваше податке. Овај опис је привремен – комплетан текст биће додат касније.', orderStepContinue: 'Настави', paymentTitle: 'Плаћање', paymentOrderSummary: 'Резиме наруџбине', paymentPlan: 'План', paymentVin: 'VIN', paymentSubtotal: 'Међузбир', paymentDiscount: 'Попуст', paymentTotal: 'Укупно', paymentDiscountCode: 'Код за попуст', paymentDiscountPlaceholder: 'Унесите код', paymentApply: 'Примени', paymentPay: 'Плати', paymentSecure: 'Безбедно плаћање', paymentCodeInvalid: 'Неважећи код за попуст', paymentCodeApplied: 'Попуст примењен', discountBannerMessage: 'Додатни {percent}% попуст ће бити примењен при плаћању', paymentApiUnavailable: 'API за плаћање није доступан. Локално покрените: vercel dev (не npm run dev).', paymentFormLoading: 'Припрема форме за плаћање…', paymentOrPayAnotherWay: 'Или платите на други начин', paymentMethod: 'Начин плаћања', paymentCard: 'Картица', paymentLink: 'Линк', paymentApplePay: 'Apple Pay', paymentEmail: 'Имејл', paymentOr: 'или', paymentExpressCheckout: 'Express: Apple Pay, Google Pay (приказано испод ако је подржано)', planSingle: 'Појединачан', planPopular: 'Најпопуларнији', planBestValue: 'Најбоља вредност', report1: '1 Извештај', reports2: '2 Извештаја', reports3: '3 Извештаја', refundPolicyText: 'Корисник има право да одустане од Услуга (Извештаја) у року од 30 дана од датума куповине, подношењем захтева путем имејла са бројем наруџбине, датумом и контакт подацима. Повраћај се обрађује у року од 14 дана од пријема захтева.\n\nПовраћај се не примењује ако је извештај већ коришћен за верификацију историје возила или ако је коришћен најмање један извештај из купљеног пакета.', close: 'Затвори' },
    footer: { desc: 'Поуздан извор историје возила у Европи. Наша мисија је транспарентност на сваком километру.', privacyLink: 'Политика приватности', termsLink: 'Услови коришћења', usageInstructionsLink: 'Услови коришћења' },
    ...
    features: { mileageHistory: 'Историја километраже', mileageHistoryDesc: 'Анализирамо податке од дилера и регистара широм Европе.', damageRecords: 'Историја сервиса', damageRecordsDesc: 'Проверавамо записе о обављеним сервисним радовима и одржавању.', theftCheck: 'Провера крађе', theftCheckDesc: 'Проверавамо базе података да ли је возило било украдено.' },
  ...
  no: {
    ...
    nav: { services: 'Tjenester', pricing: 'Priser', sampleReport: 'Exempelrapport', settings: 'Innstillinger', login: 'Logg inn', myReports: 'Mine rapporter', signOut: 'Logg ut', deleteAccount: 'Slett konto', deleteAccountConfirm: 'Slett konto', deleteAccountConfirmText: 'Er du sikker på at du vil slette kontoen din? Alle lagrede rapporter vil bli fjernet. Denne handlingen kan ikke angres.', deleteAccountDeleting: 'Sletter…', deleteAccountError: 'Sletting mislyktes. Prøv igjen.' },
    tokenMode: { banner: 'Du har {n} av {total} rapporter. Skriv inn VIN nedenfor.', noReports: 'Ingen rapporter igjen. Kjøp en ny plan for å sjekke et annet kjøretøy.', loading: 'Laster…', error: 'Kunne ikke laste kjøpet. Sjekk lenken.', confirmationSentToEmail: 'Bekreftelse og lenke sendt til e-posten din.' },
    hero: { title: 'Oppdag kjøretøyets historikk', titleAccent: 'via VIN-kode', desc: 'Sjekk kilometerhistorikk og serviceregistre på sekunder. Profesjonell verifisering tilgjengelig for alle.', placeholder: 'Skriv inn VIN-nummer...', button: 'Sjekk', sample: 'Eksempelrapport' },
    discountWheel: { title: 'Spinn og få ekstra rabatt!', spin: 'Spinner...', spinButton: 'Spinn', spinsOfThree: 'av 3 spinn', codeLabel: 'Din rabattkode', applyDiscount: 'Bruk rabatt', close: 'Lukk', nextSpinTomorrow: 'Neste spinn tilgjengelig i morgen.' },
    pricing: { title: 'Velg riktig plan', desc: 'Hvis det ikke finnes kilometerdata i rapportene dine, vil denne rapporten ikke koste deg noe', descHighlight: 'ikke koste deg noe', bestValue: 'Beste verdi', order: 'Bestill nå', confirm: 'Bekreft', selectPlanForVin: 'Velg en plan for VIN-sjekk', refundPolicy: 'Refusjonspolicy', perReport: 'Per rapport:', orderStepTitle: 'Skriv inn e-post for rapporter', orderStepEmailLabel: 'E-postadresse der rapporter sendes', orderStepEmailPlaceholder: 'eksempel@email.no', orderStepAgreeTerms: 'Jeg godtar vilkårene og har lest personvernreglene', orderStepAgreeBeforeTerms: 'Jeg godtar ', orderStepTermsLink: 'vilkårene', orderStepAgreeBetween: ' og har lest ', orderStepPrivacyLink: 'personvernreglene', orderStepTermsText: 'Her vises tjenestevilkårene. Dette er midlertidig tekst – den endelige versjonen legges til senere.', orderStepPrivacyText: 'Her vises personvernreglene: hvordan vi samler inn, lagrer og bruker dataene dine. Denne beskrivelsen er midlertidig – den fullstendige teksten legges til senere.', orderStepContinue: 'Fortsett', paymentTitle: 'Betaling', paymentOrderSummary: 'Ordresammendrag', paymentPlan: 'Plan', paymentVin: 'VIN', paymentSubtotal: 'Delsum', paymentDiscount: 'Rabatt', paymentTotal: 'Totalt', paymentDiscountCode: 'Rabattkode', paymentDiscountPlaceholder: 'Skriv inn kode', paymentApply: 'Bruk', paymentPay: 'Betal', paymentSecure: 'Sikker betaling', paymentCodeInvalid: 'Ugyldig rabattkode', paymentCodeApplied: 'Rabatt brukt', discountBannerMessage: '{percent}% rabatt ved betaling', paymentApiUnavailable: 'Betalings-API ikke tilgjengelig. Kjør lokalt: vercel dev (ikke npm run dev).', paymentFormLoading: 'Forbereder betalingsskjema…', paymentOrPayAnotherWay: 'Eller betal på en annen måte', paymentMethod: 'Betalingsmetode', paymentCard: 'Kort', paymentLink: 'Lenke', paymentApplePay: 'Apple Pay', paymentEmail: 'E-post', paymentOr: 'eller', paymentExpressCheckout: 'Express: Apple Pay, Google Pay (vises nedenfor hvis støttet)', planSingle: 'Enkelt', planPopular: 'Mest populær', planBestValue: 'Beste verdi', report1: '1 Rapport', reports2: '2 Rapporter', reports3: '3 Rapporter', refundPolicyText: 'Brukeren har rett til å trekke seg fra Tjenestene (Rapportene) innen 30 dager fra kjøpsdatoen ved å sende en forespørsel via e-post med ordrenummer, dato og kontaktinformasjon. Refusjonen behandles innen 14 dager etter mottak av forespørselen.\n\nRefusjoner gjelder ikke hvis rapporten allerede er brukt til å verifisere kjøretøyets historikk, eller hvis minst én rapport fra den kjøpte pakken er brukt.', close: 'Lukk' },
    footer: { desc: 'Pålitelig kilde for kjøretøyhistorikk i Europa. Vårt oppdrag er åpenhet ved hver kilometer.', privacyLink: 'Personvernregler', termsLink: 'Bruksvilkår', usageInstructionsLink: 'Bruksvilkår' },
    ...
    features: { mileageHistory: 'Kilometerhistorikk', mileageHistoryDesc: 'Vi analyserer data fra forhandlere og registre i hele Europa.', damageRecords: 'Servicehistorikk', damageRecordsDesc: 'Vi kontrollerer registreringer av utført servicearbeid og vedlikehold.', theftCheck: 'Tyveriskjekk', theftCheckDesc: 'Vi sjekker databaser for å se om kjøretøyet har blitt stjålet.' },
  ...
  sk: {
    ...
    nav: { services: 'Služby', pricing: 'Cenník', sampleReport: 'Ukázkový report', settings: 'Nastavenia', login: 'Prihlásiť sa', myReports: 'Moje reporty', signOut: 'Odhlásiť sa', deleteAccount: 'Vymazať účet', deleteAccountConfirm: 'Vymazať účet', deleteAccountConfirmText: 'Naozaj chcete vymazať svoj účet? Všetky uložené reporty budú odstránené. Túto akciu nie je možné vrátiť späť.', deleteAccountDeleting: 'Mazanie…', deleteAccountError: 'Vymazanie zlyhalo. Skúste znova.' },
    tokenMode: { banner: 'Máte {n} z {total} reportov. Zadajte VIN nižšie.', noReports: 'Žiadne zostávajúce reporty. Kúpte si nový plán na kontrolu ďalšieho vozidla.', loading: 'Načítava sa…', error: 'Nepodarilo sa načítať nákup. Skontrolujte odkaz.', confirmationSentToEmail: 'Potvrdenie a odkaz boli odoslané na váš e-mail.' },
    hero: { title: 'Zistite históriu vozidla', titleAccent: 'podľa VIN kódu', desc: 'Skontrolujte históriu kilometrov a servisné záznamy za pár sekúnd. Profesionálne overenie dostupné pre každého.', placeholder: 'Zadajte číslo VIN...', button: 'Skontrolovať', sample: 'Ukážkový report' },
    discountWheel: { title: 'Točte a získajte zľavu navyše!', spin: 'Točí sa...', spinButton: 'Točiť', spinsOfThree: 'z 3 točení', codeLabel: 'Váš zľavový kód', applyDiscount: 'Použiť zľavu', close: 'Zavrieť', nextSpinTomorrow: 'Ďalšie točenie možné zajtra.' },
    pricing: { title: 'Vyberte si správny plán', desc: 'Ak vo vašich reportoch nebudú nájdené dáta o najazdených kilometroch, tento report vás nebude nič stáť', descHighlight: 'nič', bestValue: 'Najlepšia hodnota', order: 'Objednať teraz', confirm: 'Potvrdiť', selectPlanForVin: 'Vyberte plán na kontrolu VIN', refundPolicy: 'Zásady vrátenia peňazí', perReport: 'Za report:', orderStepTitle: 'Zadajte e-mail pre reporty', orderStepEmailLabel: 'E-mailová adresa, kam budú zasielané reporty', orderStepEmailPlaceholder: 'priklad@email.sk', orderStepAgreeTerms: 'Súhlasím s podmienkami a prečítal som zásady ochrany osobných údajov', orderStepAgreeBeforeTerms: 'Súhlasím s ', orderStepTermsLink: 'podmienkami', orderStepAgreeBetween: ' a prečítal som ', orderStepPrivacyLink: 'zásady ochrany osobných údajov', orderStepTermsText: 'Tu budú zobrazené podmienky služby. Toto je dočasný text – finálna verzia bude pridaná neskôr.', orderStepPrivacyText: 'Tu budú zobrazené zásady ochrany osobných údajov: ako zhromažďujeme, ukladáme a používame vaše dáta. Tento popis je dočasný – úplný text bude pridaný neskôr.', orderStepContinue: 'Pokračovať', paymentTitle: 'Platba', paymentOrderSummary: 'Zhrnutie objednávky', paymentPlan: 'Plán', paymentVin: 'VIN', paymentSubtotal: 'Medzisúčet', paymentDiscount: 'Zľava', paymentTotal: 'Celkom', paymentDiscountCode: 'Zľavový kód', paymentDiscountPlaceholder: 'Zadajte kód', paymentApply: 'Použiť', paymentPay: 'Zaplatiť', paymentSecure: 'Bezpečná platba', paymentCodeInvalid: 'Neplatný zľavový kód', paymentCodeApplied: 'Zľava použitá', discountBannerMessage: 'Dodatočná {percent}% zľava bude aplikovaná pri platbe', paymentApiUnavailable: 'Platobné API nedostupné. Lokálne spustite: vercel dev (nie npm run dev).', paymentFormLoading: 'Príprava platobného formulára…', paymentOrPayAnotherWay: 'Alebo zaplaťte inak', paymentMethod: 'Spôsob platby', paymentCard: 'Karta', paymentLink: 'Odkaz', paymentApplePay: 'Apple Pay', paymentEmail: 'E-mail', paymentOr: 'alebo', paymentExpressCheckout: 'Express: Apple Pay, Google Pay (zobrazené nižšie, ak je podporované)', planSingle: 'Jednorazový', planPopular: 'Najpopulárnejší', planBestValue: 'Najlepšia hodnota', report1: '1 Report', reports2: '2 Reporty', reports3: '3 Reporty', refundPolicyText: 'Používateľ má právo odstúpiť od Služieb (Reportov) do 30 dní od dátumu nákupu zaslaním žiadosti e-mailom s číslom objednávky, dátumom a kontaktnými údajmi. Vrátenie peňazí bude spracované do 14 dní od prijatia žiadosti.\n\nVrátenie peňazí neplatí, ak bol report už použitý na overenie histórie vozidla alebo ak bol použitý aspoň jeden report zo zakúpeného balíka.', close: 'Zavrieť' },
    footer: { desc: 'Spoľahlivý zdroj histórie vozidiel v Európe. Naším poslaním je transparentnosť na každom kilometri.', privacyLink: 'Zásady ochrany osobných údajov', termsLink: 'Podmienky používania', usageInstructionsLink: 'Podmienky používania' },
    ...
    features: { mileageHistory: 'História kilometrov', mileageHistoryDesc: 'Analyzujeme dáta od predajcov a registrov po celej Európe.', damageRecords: 'História servisu', damageRecordsDesc: 'Kontrolujeme záznamy o vykonaných servisných prácach a údržbe.', theftCheck: 'Kontrola krádeže', theftCheckDesc: 'Kontrolujeme databázy, či nebolo vozidlo odcudzené.' },
  ...
  hr: {
    ...
    nav: { services: 'Usluge', pricing: 'Cijene', sampleReport: 'Primjer izvješća', settings: 'Postavke', login: 'Prijava', myReports: 'Moja izvješća', signOut: 'Odjava', deleteAccount: 'Obriši račun', deleteAccountConfirm: 'Obriši račun', deleteAccountConfirmText: 'Jeste li sigurni da želite obrisati svoj račun? Sva spremljena izvješća bit će uklonjena. Ova radnja se ne može poništiti.', deleteAccountDeleting: 'Brisanje…', deleteAccountError: 'Brisanje nije uspjelo. Pokušajte ponovno.' },
    tokenMode: { banner: 'Imate {n} od {total} izvješća. Unesite VIN ispod.', noReports: 'Nema preostalih izvješća. Kupite novi plan za provjeru drugog vozila.', loading: 'Učitavanje…', error: 'Učitavanje kupnje nije uspjelo. Provjerite poveznicu.', confirmationSentToEmail: 'Potvrda i poveznica poslani na vaš e-mail.' },
    hero: { title: 'Otkrijte povijest vozila', titleAccent: 'putem VIN koda', desc: 'Provjerite povijest kilometraže i servisne zapise u sekundi. Profesionalna verifikacija dostupna svima.', placeholder: 'Unesite VIN broj...', button: 'Provjeri', sample: 'Primjer izvještaja' },
    discountWheel: { title: 'Vrtite i dobijte dodatni popust!', spin: 'Vrti se...', spinButton: 'Vrtjeti', spinsOfThree: 'od 3 okretaja', codeLabel: 'Vaš popust kod', applyDiscount: 'Primijeni popust', close: 'Zatvori', nextSpinTomorrow: 'Sljedeći okretaj dostupan sutra.' },
    pricing: { title: 'Odaberite pravi plan', desc: 'Ako se u vašim izvješćima ne nađu podaci o kilometraži, ovo izvješće vas neće ništa koštati', descHighlight: 'ništa', bestValue: 'Najbolja vrijednost', order: 'Naruči sada', confirm: 'Potvrdi', selectPlanForVin: 'Odaberite plan za VIN provjeru', refundPolicy: 'Politika povrata', perReport: 'Po izvješću:', orderStepTitle: 'Unesite email za izvješća', orderStepEmailLabel: 'Email adresa na koju će se slati izvješća', orderStepEmailPlaceholder: 'primjer@email.hr', orderStepAgreeTerms: 'Slažem se s uvjetima i pročitao sam politiku privatnosti', orderStepAgreeBeforeTerms: 'Slažem se s ', orderStepTermsLink: 'uvjetima', orderStepAgreeBetween: ' i pročitao sam ', orderStepPrivacyLink: 'politiku privatnosti', orderStepTermsText: 'Ovdje će biti prikazani uvjeti korištenja. Ovo je privremeni tekst – konačna verzija bit će dodana kasnije.', orderStepPrivacyText: 'Ovdje će biti prikazana politika privatnosti: kako prikupljamo, pohranjujemo i koristimo vaše podatke. Ovaj opis je privremen – puni tekst bit će dodan kasnije.', orderStepContinue: 'Nastavi', paymentTitle: 'Plaćanje', paymentOrderSummary: 'Sažetak narudžbe', paymentPlan: 'Plan', paymentVin: 'VIN', paymentSubtotal: 'Međuzbroj', paymentDiscount: 'Popust', paymentTotal: 'Ukupno', paymentDiscountCode: 'Kod za popust', paymentDiscountPlaceholder: 'Unesite kod', paymentApply: 'Primijeni', paymentPay: 'Plati', paymentSecure: 'Sigurno plaćanje', paymentCodeInvalid: 'Nevažeći kod za popust', paymentCodeApplied: 'Popust primijenjen', discountBannerMessage: 'Dodatni {percent}% popust primijenjen pri plaćanju', paymentApiUnavailable: 'API za plaćanje nije dostupan. Lokalno pokrenite: vercel dev (ne npm run dev).', paymentFormLoading: 'Priprema obrasca za plaćanje…', paymentOrPayAnotherWay: 'Ili platite na drugi način', paymentMethod: 'Način plaćanja', paymentCard: 'Kartica', paymentLink: 'Poveznica', paymentApplePay: 'Apple Pay', paymentEmail: 'Email', paymentOr: 'ili', paymentExpressCheckout: 'Express: Apple Pay, Google Pay (prikazano ispod ako je podržano)', planSingle: 'Pojedinačno', planPopular: 'Najpopularnije', planBestValue: 'Najbolja vrijednost', report1: '1 Izvješće', reports2: '2 Izvješća', reports3: '3 Izvješća', refundPolicyText: 'Korisnik ima pravo odustati od Usluga (Izvješća) u roku od 30 dana od datuma kupnje, podnošenjem zahtjeva putem emaila s brojem narudžbe, datumom i kontakt podacima. Povrat se obrađuje u roku od 14 dana od primitka zahtjeva.\n\nPovrat se ne primjenjuje ako je izvješće već korišteno za provjeru povijesti vozila ili ako je korišteno barem jedno izvješće iz kupljenog paketa.', close: 'Zatvori' },
    footer: { desc: 'Pouzdan izvor povijesti vozila u Europi. Naša misija je transparentnost na svakom kilometru.', privacyLink: 'Politika privatnosti', termsLink: 'Uvjeti korištenja', usageInstructionsLink: 'Uvjeti korištenja' },
  ...
  bs: {
    ...
    nav: { services: 'Usluge', pricing: 'Cijene', sampleReport: 'Primjer izvještaja', settings: 'Postavke', login: 'Prijava', myReports: 'Moji izvještaji', signOut: 'Odjava', deleteAccount: 'Obriši račun', deleteAccountConfirm: 'Obriši račun', deleteAccountConfirmText: 'Jeste li sigurni da želite obrisati svoj račun? Svi spremljeni izvještaji bit će uklonjeni. Ova radnja se ne može poništiti.', deleteAccountDeleting: 'Brisanje…', deleteAccountError: 'Brisanje nije uspjelo. Pokušajte ponovo.' },
    tokenMode: { banner: 'Imate {n} od {total} izvještaja. Unesite VIN ispod.', noReports: 'Nema preostalih izvještaja. Kupite novi plan za provjeru drugog vozila.', loading: 'Učitavanje…', error: 'Učitavanje kupovine nije uspjelo. Provjerite link.', confirmationSentToEmail: 'Potvrda i link poslani na vaš e-mail.' },
    hero: { title: 'Otkrijte historiju vozila', titleAccent: 'putem VIN koda', desc: 'Provjerite historiju kilometraže i servisne zapise u sekundi. Profesionalna verifikacija dostupna svima.', placeholder: 'Unesite VIN broj...', button: 'Provjeri', sample: 'Primjer izvještaja' },
    discountWheel: { title: 'Vrtite i dobijte dodatni popust!', spin: 'Vrti se...', spinButton: 'Vrtjeti', spinsOfThree: 'od 3 okretaja', codeLabel: 'Vaš popust kod', applyDiscount: 'Primijeni popust', close: 'Zatvori', nextSpinTomorrow: 'Sljedeći okretaj dostupan sutra.' },
    pricing: { title: 'Odaberite pravi plan', desc: 'Ako se u vašim izvještajima ne nađu podaci o kilometraži, ovaj izvještaj vas neće ništa koštati', descHighlight: 'ništa', bestValue: 'Najbolja vrijednost', order: 'Naruči sada', confirm: 'Potvrdi', selectPlanForVin: 'Odaberite plan za VIN provjeru', refundPolicy: 'Politika povrata', perReport: 'Po izvještaju:', orderStepTitle: 'Unesite email za izvještaje', orderStepEmailLabel: 'Email adresa na koju će se slati izvještaji', orderStepEmailPlaceholder: 'primjer@email.ba', orderStepAgreeTerms: 'Slažem se s uslovima i pročitao sam politiku privatnosti', orderStepAgreeBeforeTerms: 'Slažem se s ', orderStepTermsLink: 'uslovima', orderStepAgreeBetween: ' i pročitao sam ', orderStepPrivacyLink: 'politiku privatnosti', orderStepTermsText: 'Ovdje će biti prikazani uslovi korištenja. Ovo je privremeni tekst – konačna verzija bit će dodana kasnije.', orderStepPrivacyText: 'Ovdje će biti prikazana politika privatnosti: kako prikupljamo, pohranjujemo i koristimo vaše podatke. Ovaj opis je privremen – puni tekst bit će dodan kasnije.', orderStepContinue: 'Nastavi', paymentTitle: 'Plaćanje', paymentOrderSummary: 'Sažetak narudžbe', paymentPlan: 'Plan', paymentVin: 'VIN', paymentSubtotal: 'Međuzbroj', paymentDiscount: 'Popust', paymentTotal: 'Ukupno', paymentDiscountCode: 'Kod za popust', paymentDiscountPlaceholder: 'Unesite kod', paymentApply: 'Primijeni', paymentPay: 'Plati', paymentSecure: 'Sigurno plaćanje', paymentCodeInvalid: 'Nevažeći kod za popust', paymentCodeApplied: 'Popust primijenjen', discountBannerMessage: 'Dodatni {percent}% popust primijenjen pri plaćanju', paymentApiUnavailable: 'API za plaćanje nije dostupan. Lokalno pokrenite: vercel dev (ne npm run dev).', paymentFormLoading: 'Priprema obrasca za plaćanje…', paymentOrPayAnotherWay: 'Ili platite na drugi način', paymentMethod: 'Način plaćanja', paymentCard: 'Kartica', paymentLink: 'Link', paymentApplePay: 'Apple Pay', paymentEmail: 'Email', paymentOr: 'ili', paymentExpressCheckout: 'Express: Apple Pay, Google Pay (prikazano ispod ako je podržano)', planSingle: 'Pojedinačno', planPopular: 'Najpopularnije', planBestValue: 'Najbolja vrijednost', report1: '1 Izvještaj', reports2: '2 Izvještaja', reports3: '3 Izvještaja', refundPolicyText: 'Korisnik ima pravo odustati od Usluga (Izvještaja) u roku od 30 dana od datuma kupovine, podnošenjem zahtjeva putem emaila s brojem narudžbe, datumom i kontakt podacima. Povrat se obrađuje u roku od 14 dana od primitka zahtjeva.\n\nPovrat se ne primjenjuje ako je izvještaj već korišten za provjeru historije vozila ili ako je korišten barem jedan izvještaj iz kupljenog paketa.', close: 'Zatvori' },
    footer: { desc: 'Pouzdan izvor historije vozila u Evropi. Naša misija je transparentnost na svakom kilometru.', privacyLink: 'Politika privatnosti', termsLink: 'Uslovi korištenja', usageInstructionsLink: 'Uslovi korištenja' },
  ...
  sq: {
    ...
    features: { mileageHistory: 'Historia e kilometrave', mileageHistoryDesc: 'Analizojmë të dhënat nga tregtarët dhe regjistrat në të gjithë Europën.', damageRecords: 'Historia e servisit', damageRecordsDesc: 'Kontrollojmë regjistrimet e punëve të servisit dhe mirëmbajtjes së kryer.', theftCheck: 'Kontrolli i vjedhjes', theftCheckDesc: 'Kontrollojmë bazat e të dhënave nëse automobili është vjedhur.' },
  ...
  sl: {
    ...
    features: { mileageHistory: 'Zgodovina kilometrov', mileageHistoryDesc: 'Analiziramo podatke od trgovcev in registrov po vsej Evropi.', damageRecords: 'Zgodovina servisiranja', damageRecordsDesc: 'Preverjamo evidence o opravljenih servisnih delih in vzdrževanju.', theftCheck: 'Preverjanje kraje', theftCheckDesc: 'Preverjamo baze podatkov, ali je bilo vozilo ukradeno.' },
  ...
  lv: {
    ...
    nav: { services: 'Pakalpojumi', pricing: 'Cenas', sampleReport: 'Parauga pārskats', settings: 'Iestatījumi', login: 'Pieslēgties', myReports: 'Mani pārskati', signOut: 'Iziet', deleteAccount: 'Dzēst kontu', deleteAccountConfirm: 'Dzēst kontu', deleteAccountConfirmText: 'Vai esat pārliecināts, ka vēlaties dzēst savu kontu? Visi saglabātie pārskati tiks noņemti. Šo darbību nevar atsaukt.', deleteAccountDeleting: 'Dzēš…', deleteAccountError: 'Dzēšana neizdevās. Mēģiniet vēlreiz.' },
    tokenMode: { banner: 'Jums ir {n} no {total} pārskatiem. Ievadiet VIN zemāk.', noReports: 'Nav atlikušo pārskatu. Iegādājieties jaunu plānu cita transportlīdzekļa pārbaudei.', loading: 'Ielādē…', error: 'Pirkuma ielāde neizdevās. Pārbaudiet saiti.', confirmationSentToEmail: 'Apstiprinājums un saite nosūtīta uz jūsu e-pastu.' },
    hero: { title: 'Uzziniet transportlīdzekļa vēsturi', titleAccent: 'pēc VIN koda', desc: 'Pārbaudiet nobraukuma vēsturi un apkopes ierakstus dažās sekundēs. Profesionāla pārbaude pieejama ikvienam.', placeholder: 'Ievadiet VIN numuru...', button: 'Pārbaudīt', sample: 'Pārskata paraugs' },
    discountWheel: { title: 'Grieziet un saņemiet papildu atlaidi!', spin: 'Griežas...', spinButton: 'Griezt', spinsOfThree: 'no 3 griezieniem', codeLabel: 'Jūsu atlaides kods', applyDiscount: 'Pielietot atlaidi', close: 'Aizvērt', nextSpinTomorrow: 'Nākamais grieziens pieejams rīt.' },
    pricing: { title: 'Izvēlieties piemērotu plānu', desc: 'Ja jūsu pārskatos netiks atrasti nobraukuma dati, šis pārskats jums neko nemaksās', descHighlight: 'neko nemaksās', bestValue: 'Labākā vērtība', order: 'Pasūtīt tagad', confirm: 'Apstiprināt', selectPlanForVin: 'Izvēlieties plānu VIN pārbaudei', refundPolicy: 'Atmaksas politika', perReport: 'Par pārskatu:', orderStepTitle: 'Ievadiet e-pastu pārskatiem', orderStepEmailLabel: 'E-pasta adrese, uz kuru tiks nosūtīti pārskati', orderStepEmailPlaceholder: 'piemers@epasts.lv', orderStepAgreeTerms: 'Piekrītu noteikumiem un esmu izlasījis privātuma politiku', orderStepAgreeBeforeTerms: 'Piekrītu ', orderStepTermsLink: 'noteikumiem', orderStepAgreeBetween: ' un esmu izlasījis ', orderStepPrivacyLink: 'privātuma politiku', orderStepTermsText: 'Šeit tiks parādīti lietošanas noteikumi.', orderStepPrivacyText: 'Šeit tiks parādīta privātuma politika.', orderStepContinue: 'Turpināt', paymentTitle: 'Maksājums', paymentOrderSummary: 'Pasūtījuma kopsavilkums', paymentPlan: 'Plāns', paymentVin: 'VIN', paymentSubtotal: 'Starpsumma', paymentDiscount: 'Atlaide', paymentTotal: 'Kopā', paymentDiscountCode: 'Atlaides kods', paymentDiscountPlaceholder: 'Ievadiet kodu', paymentApply: 'Lietot', paymentPay: 'Maksāt', paymentSecure: 'Drošs maksājums', paymentCodeInvalid: 'Nederīgs atlaides kods', paymentCodeApplied: 'Atlaide piemērota', discountBannerMessage: 'Papildu {percent}% atlaide pie maksājuma', paymentApiUnavailable: 'Maksājumu API nav pieejams.', paymentFormLoading: 'Sagatavo maksājuma formu…', paymentOrPayAnotherWay: 'Vai maksājiet citādi', paymentMethod: 'Maksājuma veids', paymentCard: 'Karte', paymentLink: 'Saite', paymentApplePay: 'Apple Pay', paymentEmail: 'E-pasts', paymentOr: 'vai', paymentExpressCheckout: 'Express: Apple Pay, Google Pay', planSingle: 'Atsevišķs', planPopular: 'Populārākais', planBestValue: 'Labākā vērtība', report1: '1 Pārskats', reports2: '2 Pārskati', reports3: '3 Pārskati', refundPolicyText: 'Lietotājam ir tiesības atteikties no Pakalpojumiem (Pārskatiem) 30 dienu laikā no pirkuma datuma.', close: 'Aizvērt' },
    footer: { desc: 'Uzticams transportlīdzekļu vēstures avots Eiropā.', privacyLink: 'Privātuma politika', termsLink: 'Lietošanas noteikumi', usageInstructionsLink: 'Lietošanas noteikumi' },
    ...
    features: { mileageHistory: 'Nobraukuma vēsture', mileageHistoryDesc: 'Analizējam datus no tirgotājiem un reģistriem visā Eiropā.', damageRecords: 'Servisa vēsture', damageRecordsDesc: 'Pārbaudām ierakstus par veiktajiem servisa darbiem un apkopi.', theftCheck: 'Zādzības pārbaude', theftCheckDesc: 'Pārbaudām datu bāzes, vai transportlīdzeklis nav nozagts.' },
  ...
  mk: {
    ...
    features: { mileageHistory: 'Историја на километража', mileageHistoryDesc: 'Анализираме податоци од цела Европа.', damageRecords: 'Историја на сервис', damageRecordsDesc: 'Проверуваме записи за извршени сервисни работи и одржување.', theftCheck: 'Проверка на кражба', theftCheckDesc: 'Проверуваме бази податоци дали возилото е било украдено.' },
  ...
  et: {
    ...
    nav: { services: 'Teenused', pricing: 'Hinnad', sampleReport: 'Näidisaruanne', settings: 'Seaded', login: 'Logi sisse', myReports: 'Minu aruanded', signOut: 'Logi välja', deleteAccount: 'Kustuta konto', deleteAccountConfirm: 'Kustuta konto', deleteAccountConfirmText: 'Kas olete kindel, et soovite oma konto kustutada?', deleteAccountDeleting: 'Kustutamine…', deleteAccountError: 'Kustutamine ebaõnnestus.' },
    tokenMode: { banner: 'Teil on {n}/{total} aruannet.', noReports: 'Aruandeid pole. Ostke uus pakett.', loading: 'Laadimine…', error: 'Laadimine ebaõnnestus.', confirmationSentToEmail: 'Kinnitus ja link saadetud teie e-mailile.' },
    hero: { title: 'Avastage sõiduki ajalugu', titleAccent: 'VIN-koodi järgi', desc: 'Kontrollige läbisõidu ajalugu ja teenindusregistrit sekunditega.', placeholder: 'Sisestage VIN-number...', button: 'Kontrolli', sample: 'Näidisaruanne' },
    discountWheel: { title: 'Pöörake ja saage lisaallahindlust!', spin: 'Pöörleb...', spinButton: 'Pööra', spinsOfThree: '3 pöördest', codeLabel: 'Teie allahindluskood', applyDiscount: 'Rakenda allahindlus', close: 'Sulge', nextSpinTomorrow: 'Järgmine pööre saadaval homme.' },
    pricing: { title: 'Valige õige pakett', desc: 'Säästate mitme kontrolli korraga ostmisega.', bestValue: 'Parim väärtus', order: 'Telli nüüd', confirm: 'Kinnita', selectPlanForVin: 'Valige pakett VIN-kontrolliks', refundPolicy: 'Tagastuspoliitika', perReport: 'Aruande kohta:', orderStepTitle: 'Sisestage e-post aruannete jaoks', orderStepEmailLabel: 'E-posti aadress', orderStepEmailPlaceholder: 'näide@email.ee', orderStepAgreeTerms: 'Nõustun tingimustega', orderStepAgreeBeforeTerms: 'Nõustun ', orderStepTermsLink: 'tingimustega', orderStepAgreeBetween: ' ja lugesin ', orderStepPrivacyLink: 'privaatsuspoliitikat', orderStepTermsText: 'Kasutustingimused.', orderStepPrivacyText: 'Privaatsuspoliitika.', orderStepContinue: 'Jätka', paymentTitle: 'Makse', paymentOrderSummary: 'Tellimuse kokkuvõte', paymentPlan: 'Pakett', paymentVin: 'VIN', paymentSubtotal: 'Vahesumma', paymentDiscount: 'Allahindlus', paymentTotal: 'Kokku', paymentDiscountCode: 'Sooduskood', paymentDiscountPlaceholder: 'Sisestage kood', paymentApply: 'Rakenda', paymentPay: 'Maksa', paymentSecure: 'Turvaline makse', paymentCodeInvalid: 'Vale kood', paymentCodeApplied: 'Allahindlus rakendatud', discountBannerMessage: 'Täiendav {percent}% allahindlus rakendatakse maksel', paymentApiUnavailable: 'Makse API pole saadaval.', paymentFormLoading: 'Ettevalmistamine…', paymentOrPayAnotherWay: 'Või makske teisiti', paymentMethod: 'Makseviis', paymentCard: 'Kaart', paymentLink: 'Link', paymentApplePay: 'Apple Pay', paymentEmail: 'E-post', paymentOr: 'või', paymentExpressCheckout: 'Express', planSingle: 'Üksik', planPopular: 'Populaarseim', planBestValue: 'Parim väärtus', report1: '1 Aruanne', reports2: '2 Aruannet', reports3: '3 Aruannet', refundPolicyText: 'Tagastuspoliitika.', close: 'Sulge' },
    footer: { desc: 'Usaldusväärne sõidukite ajaloo allikas Euroopas.', privacyLink: 'Privaatsuspoliitika', termsLink: 'Kasutustingimused', usageInstructionsLink: 'Kasutustingimused' },
    ...
    features: { mileageHistory: 'Läbisõidu ajalugu', mileageHistoryDesc: 'Analüüsime andmeid kogu Euroopast.', damageRecords: 'Teenindusajalugu', damageRecordsDesc: 'Kontrollime tehtud hooldustööde ja hoolduse kirjeid.', theftCheck: 'Varguse kontroll', theftCheckDesc: 'Kontrollime andmebaase, kas sõiduk on varastatud.' },
  ...
  tr: {
    ...
    nav: { services: 'Hizmetler', pricing: 'Fiyatlar', sampleReport: 'Örnek rapor', settings: 'Ayarlar', login: 'Giriş', myReports: 'Raporlarım', signOut: 'Çıkış', deleteAccount: 'Hesabı Sil', deleteAccountConfirm: 'Hesabı Sil', deleteAccountConfirmText: 'Hesabınızı silmek istediğinizden emin misiniz?', deleteAccountDeleting: 'Siliniyor…', deleteAccountError: 'Silme başarısız.' },
    tokenMode: { banner: '{n}/{total} raporunuz var.', noReports: 'Rapor kalmadı.', loading: 'Yükleniyor…', error: 'Yükleme başarısız.', confirmationSentToEmail: 'Onay ve bağlantı e-postanıza gönderildi.' },
    hero: { title: 'Araç geçmişini keşfedin', titleAccent: 'VIN koduyla', desc: 'Kilometre geçmişini ve servis kayıtlarını saniyeler içinde kontrol edin.', placeholder: 'VIN numarası girin...', button: 'Kontrol Et', sample: 'Örnek rapor' },
    discountWheel: { title: 'Çevirin ve ekstra indirim kazanın!', spin: 'Dönüyor...', spinButton: 'Çevir', spinsOfThree: '3 çevirmeden', codeLabel: 'İndirim kodunuz', applyDiscount: 'İndirimi uygula', close: 'Kapat', nextSpinTomorrow: 'Sonraki çevirme yarın mevcut.' },
    pricing: { title: 'Doğru planı seçin', desc: 'Toplu kontrol alarak tasarruf edin.', bestValue: 'En İyi Değer', order: 'Şimdi Sipariş Ver', confirm: 'Onayla', selectPlanForVin: 'VIN kontrolü için plan seçin', refundPolicy: 'İade Politikası', perReport: 'Rapor başına:', orderStepTitle: 'Raporlar için e-posta girin', orderStepEmailLabel: 'E-posta adresi', orderStepEmailPlaceholder: 'ornek@email.com', orderStepAgreeTerms: 'Şartları kabul ediyorum', orderStepAgreeBeforeTerms: '', orderStepTermsLink: 'Şartlar', orderStepAgreeBetween: ' ve ', orderStepPrivacyLink: 'Gizlilik Politikası', orderStepTermsText: 'Kullanım şartları.', orderStepPrivacyText: 'Gizlilik politikası.', orderStepContinue: 'Devam', paymentTitle: 'Ödeme', paymentOrderSummary: 'Sipariş Özeti', paymentPlan: 'Plan', paymentVin: 'VIN', paymentSubtotal: 'Ara Toplam', paymentDiscount: 'İndirim', paymentTotal: 'Toplam', paymentDiscountCode: 'İndirim Kodu', paymentDiscountPlaceholder: 'Kod girin', paymentApply: 'Uygula', paymentPay: 'Öde', paymentSecure: 'Güvenli Ödeme', paymentCodeInvalid: 'Geçersiz kod', paymentCodeApplied: 'İndirim uygulandı', discountBannerMessage: 'Ek {percent}% indirim ödemede uygulanacak', paymentApiUnavailable: 'Ödeme API mevcut değil.', paymentFormLoading: 'Hazırlanıyor…', paymentOrPayAnotherWay: 'Veya başka şekilde öde', paymentMethod: 'Ödeme Yöntemi', paymentCard: 'Kart', paymentLink: 'Link', paymentApplePay: 'Apple Pay', paymentEmail: 'E-posta', paymentOr: 'veya', paymentExpressCheckout: 'Express', planSingle: 'Tekli', planPopular: 'En Popüler', planBestValue: 'En İyi Değer', report1: '1 Rapor', reports2: '2 Rapor', reports3: '3 Rapor', refundPolicyText: 'İade politikası.', close: 'Kapat' },
    footer: { desc: 'Avrupa\'da güvenilir araç geçmişi kaynağı.', privacyLink: 'Gizlilik Politikası', termsLink: 'Kullanım Şartları', usageInstructionsLink: 'Kullanım Şartları' },
    ...
    features: { mileageHistory: 'Kilometre Geçmişi', mileageHistoryDesc: 'Avrupa genelinde veri analizi.', damageRecords: 'Servis Geçmişi', damageRecordsDesc: 'Yapılan servis işleri ve bakım kayıtlarını kontrol ediyoruz.', theftCheck: 'Hırsızlık Kontrolü', theftCheckDesc: 'Veritabanlarını kontrol ediyoruz – aracın çalıntı olup olmadığını.' },
  ...
  ca: {
    ...
    nav: { services: 'Serveis', pricing: 'Preus', sampleReport: 'Informe de mostra', settings: 'Configuració', login: 'Iniciar sessió', myReports: 'Els meus informes', signOut: 'Tancar sessió', deleteAccount: 'Eliminar compte', deleteAccountConfirm: 'Eliminar compte', deleteAccountConfirmText: 'Esteu segur que voleu eliminar el vostre compte?', deleteAccountDeleting: 'Eliminant…', deleteAccountError: 'Error en eliminar.' },
    tokenMode: { banner: 'Teniu {n} de {total} informes.', noReports: 'No queden informes.', loading: 'Carregant…', error: 'Error en carregar.', confirmationSentToEmail: 'Confirmació i enllaç enviats al vostre correu.' },
    hero: { title: 'Descobriu la història del vehicle', titleAccent: 'per codi VIN', desc: 'Comproveu la història del quilometratge i els registres de servei en segons.', placeholder: 'Introduïu el número VIN...', button: 'Comprovar', sample: 'Exemple d\'informe' },
    discountWheel: { title: 'Gireu i obteniu un descompte extra!', spin: 'Girant...', spinButton: 'Girar', spinsOfThree: 'de 3 girs', codeLabel: 'El vostre codi de descompte', applyDiscount: 'Aplicar descompte', close: 'Tancar', nextSpinTomorrow: 'Següent gir disponible demà.' },
    pricing: { title: 'Trieu el pla adequat', desc: 'Estalvieu comprant múltiples comprovacions.', bestValue: 'Millor valor', order: 'Demanar ara', confirm: 'Confirmar', selectPlanForVin: 'Seleccioneu un pla', refundPolicy: 'Política de reemborsament', perReport: 'Per informe:', orderStepTitle: 'Introduïu email', orderStepEmailLabel: 'Adreça email', orderStepEmailPlaceholder: 'exemple@email.cat', orderStepAgreeTerms: 'Accepto els termes', orderStepAgreeBeforeTerms: 'Accepto ', orderStepTermsLink: 'els termes', orderStepAgreeBetween: ' i ', orderStepPrivacyLink: 'política de privacitat', orderStepTermsText: 'Termes de servei.', orderStepPrivacyText: 'Política de privacitat.', orderStepContinue: 'Continuar', paymentTitle: 'Pagament', paymentOrderSummary: 'Resum de comanda', paymentPlan: 'Pla', paymentVin: 'VIN', paymentSubtotal: 'Subtotal', paymentDiscount: 'Descompte', paymentTotal: 'Total', paymentDiscountCode: 'Codi de descompte', paymentDiscountPlaceholder: 'Introduïu codi', paymentApply: 'Aplicar', paymentPay: 'Pagar', paymentSecure: 'Pagament segur', paymentCodeInvalid: 'Codi invàlid', paymentCodeApplied: 'Descompte aplicat', discountBannerMessage: 'Descompte addicional del {percent}% aplicat a la compra', paymentApiUnavailable: 'API no disponible.', paymentFormLoading: 'Preparant…', paymentOrPayAnotherWay: 'O pagueu altrament', paymentMethod: 'Mètode de pagament', paymentCard: 'Targeta', paymentLink: 'Enllaç', paymentApplePay: 'Apple Pay', paymentEmail: 'Email', paymentOr: 'o', paymentExpressCheckout: 'Express', planSingle: 'Únic', planPopular: 'Més popular', planBestValue: 'Millor valor', report1: '1 Informe', reports2: '2 Informes', reports3: '3 Informes', refundPolicyText: 'Política de reemborsament.', close: 'Tancar' },
    footer: { desc: 'Font fiable d\'història de vehicles a Europa.', privacyLink: 'Política de privacitat', termsLink: 'Termes d\'ús', usageInstructionsLink: "Termes d'ús" },
    ...
    features: { mileageHistory: 'Història quilometratge', mileageHistoryDesc: 'Analitzem dades de tota Europa.', damageRecords: 'Historial de servei', damageRecordsDesc: 'Comprovem els registres de treballs de servei i manteniment realitzats.', theftCheck: 'Comprovació robatori', theftCheckDesc: 'Comprovem bases de dades si el vehicle ha estat robat.' },
  ...
  is: {
    ...
    nav: { services: 'Þjónusta', pricing: 'Verð', sampleReport: 'Sýniskýrsla', settings: 'Stillingar', login: 'Innskráning', myReports: 'Skýrslurnar mínar', signOut: 'Útskráning', deleteAccount: 'Eyða reikningi', deleteAccountConfirm: 'Eyða reikningi', deleteAccountConfirmText: 'Ertu viss um að þú viljir eyða reikningnum þínum?', deleteAccountDeleting: 'Eyðir…', deleteAccountError: 'Eyðing mistókst.' },
    tokenMode: { banner: 'Þú átt {n} af {total} skýrslum.', noReports: 'Engar skýrslur eftir.', loading: 'Hleður…', error: 'Hleðsla mistókst.', confirmationSentToEmail: 'Staðfesting og hlekkur sendur á tölvupóstinn þinn.' },
    hero: { title: 'Uppgötvaðu sögu ökutækis', titleAccent: 'með VIN númer', desc: 'Athugaðu kílómetrasögu og þjónustuskrár á sekúndum.', placeholder: 'Sláðu inn VIN númer...', button: 'Athuga', sample: 'Sýnishornsskýrsla' },
    discountWheel: { title: 'Snúðu og fáðu aukalega afslátt!', spin: 'Snýst...', spinButton: 'Snúa', spinsOfThree: 'af 3 snúningum', codeLabel: 'Afsláttarkóðinn þinn', applyDiscount: 'Nota afslátt', close: 'Loka', nextSpinTomorrow: 'Næsti snúningur tiltækur á morgun.' },
    pricing: { title: 'Veldu rétta pakka', desc: 'Ef engin kílómetragögn finnast í skýrslum þínum kostar þessi skýrsla þig ekkert', descHighlight: 'ekkert', bestValue: 'Besta gildi', order: 'Panta núna', confirm: 'Staðfesta', selectPlanForVin: 'Veldu pakka fyrir VIN athugun', refundPolicy: 'Endurgreiðslustefna', perReport: 'Á skýrslu:', orderStepTitle: 'Sláðu inn tölvupóst', orderStepEmailLabel: 'Tölvupóstfang', orderStepEmailPlaceholder: 'daemi@postur.is', orderStepAgreeTerms: 'Ég samþykki skilmála', orderStepAgreeBeforeTerms: 'Ég samþykki ', orderStepTermsLink: 'skilmála', orderStepAgreeBetween: ' og ', orderStepPrivacyLink: 'persónuverndarstefnu', orderStepTermsText: 'Þjónustuskilmálar.', orderStepPrivacyText: 'Persónuverndarstefna.', orderStepContinue: 'Halda áfram', paymentTitle: 'Greiðsla', paymentOrderSummary: 'Samantekt pöntunar', paymentPlan: 'Pakki', paymentVin: 'VIN', paymentSubtotal: 'Millisamtala', paymentDiscount: 'Afsláttur', paymentTotal: 'Samtals', paymentDiscountCode: 'Afsláttarkóði', paymentDiscountPlaceholder: 'Sláðu inn kóða', paymentApply: 'Nota', paymentPay: 'Greiða', paymentSecure: 'Örugg greiðsla', paymentCodeInvalid: 'Ógildur kóði', paymentCodeApplied: 'Afsláttur notaður', discountBannerMessage: 'Viðbótar {percent}% afsláttur við greiðslu', paymentApiUnavailable: 'Greiðslu API ekki tiltækt.', paymentFormLoading: 'Undirbýr…', paymentOrPayAnotherWay: 'Eða greiddu á annan hátt', paymentMethod: 'Greiðslumáti', paymentCard: 'Kort', paymentLink: 'Hlekkur', paymentApplePay: 'Apple Pay', paymentEmail: 'Tölvupóstur', paymentOr: 'eða', paymentExpressCheckout: 'Express', planSingle: 'Stök', planPopular: 'Vinsælust', planBestValue: 'Besta gildi', report1: '1 Skýrsla', reports2: '2 Skýrslur', reports3: '3 Skýrslur', refundPolicyText: 'Endurgreiðslustefna.', close: 'Loka' },
    footer: { desc: 'Áreiðanleg heimild fyrir sögu ökutækja í Evrópu.', privacyLink: 'Persónuverndarstefna', termsLink: 'Notkunarskilmálar', usageInstructionsLink: 'Notkunarskilmálar' },
    ...
    features: { mileageHistory: 'Kílómetrasaga', mileageHistoryDesc: 'Greinum gögn frá Evrópu.', damageRecords: 'Þjónustusaga', damageRecordsDesc: 'Við athugum skrár yfir unnin þjónustuverk og viðhald.', theftCheck: 'Þjófnaðarathugun', theftCheckDesc: 'Við athugum gagnagrunna hvort ökutækið hafi verið stolið.' },
  ...
  lb: {
    ...
    features: { mileageHistory: 'Kilometer Geschicht', mileageHistoryDesc: 'Mir analyséieren Daten aus ganz Europa.', damageRecords: 'Service Geschicht', damageRecordsDesc: 'Mir préifen Opzeechnunge vun duerchgeféierte Serviceaarbechten an Entretien.', theftCheck: 'Déifstall Préifung', theftCheckDesc: 'Mir préifen Donnéeën-Datenbanke fir ze kucken ob de Gefier gestuel gouf.' },
  ...
  cnr: {
    ...
    tokenMode: { banner: 'Imate {n} od {total} izvještaja.', noReports: 'Nema izvještaja.', loading: 'Učitavanje…', error: 'Greška.', confirmationSentToEmail: 'Potvrda i link poslani na vaš e-mail.' },
    hero: { title: 'Otkrijte istoriju vozila', titleAccent: 'putem VIN koda', desc: 'Provjerite kilometražu i servisne zapise.', placeholder: 'Unesite VIN...', button: 'Provjeri', sample: 'Primjer izvještaja' },
    discountWheel: { title: 'Vrtite i dobijte dodatni popust!', spin: 'Vrti se...', spinButton: 'Vrtjeti', spinsOfThree: 'od 3 okretaja', codeLabel: 'Vaš popust kod', applyDiscount: 'Primijeni popust', close: 'Zatvori', nextSpinTomorrow: 'Sljedeći okretaj dostupan sutra.' },
    pricing: { title: 'Izaberite plan', desc: 'Ako se ne nađu podaci o kilometraži u izvještajima, ovaj izvještaj vas neće ništa koštati', descHighlight: 'ništa', bestValue: 'Najbolja vrijednost', order: 'Naruči', confirm: 'Potvrdi', selectPlanForVin: 'Izaberite plan', refundPolicy: 'Povrat novca', perReport: 'Po izvještaju:', orderStepTitle: 'Email', orderStepEmailLabel: 'Email adresa', orderStepEmailPlaceholder: 'primjer@email.me', orderStepAgreeTerms: 'Prihvatam uslove', orderStepAgreeBeforeTerms: 'Prihvatam ', orderStepTermsLink: 'uslove', orderStepAgreeBetween: ' i ', orderStepPrivacyLink: 'privatnost', orderStepTermsText: 'Uslovi.', orderStepPrivacyText: 'Privatnost.', orderStepContinue: 'Nastavi', paymentTitle: 'Plaćanje', paymentOrderSummary: 'Rezime', paymentPlan: 'Plan', paymentVin: 'VIN', paymentSubtotal: 'Međuzbir', paymentDiscount: 'Popust', paymentTotal: 'Ukupno', paymentDiscountCode: 'Kod', paymentDiscountPlaceholder: 'Kod', paymentApply: 'Primijeni', paymentPay: 'Plati', paymentSecure: 'Sigurno', paymentCodeInvalid: 'Nevažeći kod', paymentCodeApplied: 'Primijenjeno', discountBannerMessage: 'Dodatni {percent}% popust primijenjen pri plaćanju', paymentApiUnavailable: 'API nedostupan.', paymentFormLoading: 'Priprema…', paymentOrPayAnotherWay: 'Ili drugačije', paymentMethod: 'Način', paymentCard: 'Kartica', paymentLink: 'Link', paymentApplePay: 'Apple Pay', paymentEmail: 'Email', paymentOr: 'ili', paymentExpressCheckout: 'Express', planSingle: 'Pojedinačno', planPopular: 'Najpopularnije', planBestValue: 'Najbolja vrijednost', report1: '1 Izvještaj', reports2: '2 Izvještaja', reports3: '3 Izvještaja', refundPolicyText: 'Politika povrata.', close: 'Zatvori' },
    footer: { desc: 'Pouzdan izvor istorije vozila.', privacyLink: 'Privatnost', termsLink: 'Uslovi', usageInstructionsLink: 'Uslovi korištenja' },
    ...
    features: { mileageHistory: 'Kilometraža', mileageHistoryDesc: 'Podaci iz Evrope.', damageRecords: 'Istorija servisa', damageRecordsDesc: 'Provjeravamo zapise o obavljenim servisnim radovima.', theftCheck: 'Krađa', theftCheckDesc: 'Provjeravamo baze podataka je li vozilo bilo ukradeno.' },
  ...
  mt: {
    ...
    tokenMode: { banner: 'Għandek {n} minn {total} rapporti.', noReports: 'L-ebda rapporti.', loading: 'Qed jitgħabba…', error: 'Żball.', confirmationSentToEmail: 'Konferma u link mibgħuta lill-email tiegħek.' },
    hero: { title: 'Skopri l-istorja tal-vettura', titleAccent: 'permezz tal-VIN', desc: 'Iċċekkja l-kilometraġġ u r-reġistri tas-servizz fi sekondi.', placeholder: 'Daħħal in-numru VIN...', button: 'Iċċekkja', sample: 'Rapport tal-kampjun' },
    discountWheel: { title: 'Dawwar u ikseb skont addizzjonali!', spin: 'Qed idur...', spinButton: 'Dawwar', spinsOfThree: 'minn 3 dawriet', codeLabel: 'Il-kodiċi ta\' skont tiegħek', applyDiscount: 'Applika l-iskont', close: 'Agħlaq', nextSpinTomorrow: 'Id-dawra li jmiss disponibbli għada.' },
    pricing: { title: 'Agħżel il-pjan', desc: 'Iffranka billi tixtri aktar kontrolli.', bestValue: 'L-Aħjar Valur', order: 'Ordna Issa', confirm: 'Ikkonferma', selectPlanForVin: 'Agħżel pjan', refundPolicy: 'Politika ta\' Rifużjoni', perReport: 'Għal kull rapport:', orderStepTitle: 'Email', orderStepEmailLabel: 'Indirizz email', orderStepEmailPlaceholder: 'eżempju@email.mt', orderStepAgreeTerms: 'Naċċetta t-termini', orderStepAgreeBeforeTerms: 'Naċċetta ', orderStepTermsLink: 't-termini', orderStepAgreeBetween: ' u ', orderStepPrivacyLink: 'privatezza', orderStepTermsText: 'Termini.', orderStepPrivacyText: 'Privatezza.', orderStepContinue: 'Kompli', paymentTitle: 'Ħlas', paymentOrderSummary: 'Sommarju', paymentPlan: 'Pjan', paymentVin: 'VIN', paymentSubtotal: 'Subtotal', paymentDiscount: 'Skont', paymentTotal: 'Total', paymentDiscountCode: 'Kodiċi', paymentDiscountPlaceholder: 'Kodiċi', paymentApply: 'Applika', paymentPay: 'Ħallas', paymentSecure: 'Ħlas sigur', paymentCodeInvalid: 'Kodiċi invalidu', paymentCodeApplied: 'Applikat', discountBannerMessage: 'Skont addizzjonali ta\' {percent}% jintapplika meta tħallas', paymentApiUnavailable: 'API mhux disponibbli.', paymentFormLoading: 'Qed jipprepara…', paymentOrPayAnotherWay: 'Jew ħallas mod ieħor', paymentMethod: 'Metodu', paymentCard: 'Karta', paymentLink: 'Link', paymentApplePay: 'Apple Pay', paymentEmail: 'Email', paymentOr: 'jew', paymentExpressCheckout: 'Express', planSingle: 'Wieħed', planPopular: 'L-Aktar Popolari', planBestValue: 'L-Aħjar Valur', report1: '1 Rapport', reports2: '2 Rapporti', reports3: '3 Rapporti', refundPolicyText: 'Politika.', close: 'Agħlaq' },
    footer: { desc: 'Sors ta\' fiduċja għall-istorja tal-vetturi fl-Ewropa.', privacyLink: 'Privatezza', termsLink: 'Termini', usageInstructionsLink: 'Termini' },
    ...
    features: { mileageHistory: 'Istorja Kilometraġġ', mileageHistoryDesc: 'Data mill-Ewropa kollha.', damageRecords: 'Storja tas-Servizz', damageRecordsDesc: 'Niċċekkjaw ir-rekords ta\' xogħol ta\' servizz u manutenzjoni li saru.', theftCheck: 'Kontroll Serq', theftCheckDesc: 'Niċċekkjaw il-bażijiet tad-dejta biex naraw jekk il-vettura kinitx serqet.' },
...
const TRANSLATION_POPUP: Partial<Record<SupportedLang, { translatingReport: string; cancelTranslation: string }>> = {
  lt: { translatingReport: 'Vyksta automatinis ataskaitos vertimas', cancelTranslation: 'Atšaukti vertimą' },
  en: { translatingReport: 'Automatic report translation in progress', cancelTranslation: 'Cancel translation' },
  de: { translatingReport: 'Automatische Berichtsübersetzung läuft', cancelTranslation: 'Übersetzung abbrechen' },
  pl: { translatingReport: 'W toku automatyczne tłumaczenie raportu', cancelTranslation: 'Anuluj tłumaczenie' },
  fr: { translatingReport: 'Traduction automatique du rapport en cours', cancelTranslation: 'Annuler la traduction' },
  es: { translatingReport: 'Traducción automática del informe en curso', cancelTranslation: 'Cancelar traducción' },
  it: { translatingReport: 'Traduzione automatica del report in corso', cancelTranslation: 'Annulla traduzione' },
  nl: { translatingReport: 'Automatische rapportvertaling wordt uitgevoerd', cancelTranslation: 'Vertaling annuleren' },
  cs: { translatingReport: 'Probíhá automatický překlad reportu', cancelTranslation: 'Zrušit překlad' },
  uk: { translatingReport: 'Триває автоматичний переклад звіту', cancelTranslation: 'Скасувати переклад' },
  ro: { translatingReport: 'Traducere automată a raportului în curs', cancelTranslation: 'Anulează traducerea' },
  sv: { translatingReport: 'Automatisk rapportöversättning pågår', cancelTranslation: 'Avbryt översättning' },
  el: { translatingReport: 'Σε εξέλιξη η αυτόματη μετάφραση αναφοράς', cancelTranslation: 'Ακύρωση μετάφρασης' },
  pt: { translatingReport: 'Tradução automática do relatório em curso', cancelTranslation: 'Cancelar tradução' },
  hu: { translatingReport: 'Automatikus jelentésfordítás folyamatban', cancelTranslation: 'Fordítás megszakítása' },
  bg: { translatingReport: 'В процес е автоматичен превод на справка', cancelTranslation: 'Отказ от превод' },
  sr: { translatingReport: 'У току је аутоматски превод извештаја', cancelTranslation: 'Откажи превод' },
  da: { translatingReport: 'Automatisk rapportoversættelse i gang', cancelTranslation: 'Annuller oversættelse' },
  no: { translatingReport: 'Automatisk rapportoversettelse pågår', cancelTranslation: 'Avbryt oversettelse' },
  fi: { translatingReport: 'Automaattinen raportin käännös käynnissä', cancelTranslation: 'Peruuta käännös' },
  sk: { translatingReport: 'Prebieha automatický preklad reportu', cancelTranslation: 'Zrušiť preklad' },
  hr: { translatingReport: 'U tijeku je automatski prijevod izvještaja', cancelTranslation: 'Odustani od prijevoda' },
  bs: { translatingReport: 'U toku je automatski prevod izvještaja', cancelTranslation: 'Otkaži prevod' },
  sq: { translatingReport: 'Në proces përkthimi automatik i raportit', cancelTranslation: 'Anulo përkthimin' },
  sl: { translatingReport: 'Poteka samodejni prevod poročila', cancelTranslation: 'Prekliči prevod' },
  lv: { translatingReport: 'Notiek automātiska atskaites tulkošana', cancelTranslation: 'Atcelt tulkojumu' },
  mk: { translatingReport: 'Во тек е автоматичен превод на извештајот', cancelTranslation: 'Откажи превод' },
  et: { translatingReport: 'Automaatne aruande tõlkimine pooleli', cancelTranslation: 'Tühista tõlge' },
  ca: { translatingReport: 'Traducció automàtica de l\'informe en curs', cancelTranslation: 'Cancel·la la traducció' },
  lb: { translatingReport: 'Automatesch Iwwersetzung vum Rapport am Gaang', cancelTranslation: 'Iwwersetzung ofbriechen' },
  cnr: { translatingReport: 'U toku je automatski prevod izvještaja', cancelTranslation: 'Otkaži prevod' },
  mt: { translatingReport: 'Traduzzjoni awtomatika tar-rapport qed issir', cancelTranslation: 'Ikkanċella t-traduzzjoni' },
  is: { translatingReport: 'Sjálfvirk þýðing skýrslu í gangi', cancelTranslation: 'Hætta við þýðingu' },
  tr: { translatingReport: 'Otomatik rapor çevirisi devam ediyor', cancelTranslation: 'Çeviriyi iptal et' },
};
...
export function getTranslations(lang: LangCode | string): Translations {
  ...
  const fallback = translationsMap[FALLBACK_LANG];
  let t = translationsMap[key];
  if (!t) return fallback;
  const popup = TRANSLATION_POPUP[key] ?? TRANSLATION_POPUP[FALLBACK_LANG];
  const merged: Translations = {
    ...t,
    hero: { ...fallback?.hero, ...t?.hero },
    discountWheel: t?.discountWheel ?? fallback?.discountWheel,
  };
  if (popup && merged?.report) {
    merged.report = { ...merged.report, translatingReport: popup.translatingReport, cancelTranslation: popup.cancelTranslation };
  }
  return merged;
}
