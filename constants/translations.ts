...
const translationsMap: Record<SupportedLang, Translations> = {
  ...
  it: {
    ...
    hero: { title: 'Scopri la storia del veicolo', titleAccent: 'tramite codice VIN', desc: 'Verifica lo storico chilometrico e i registri di servizio in pochi secondi. Verifica professionale accessibile a tutti.', placeholder: 'Inserisci il numero VIN...', button: 'Verifica', sample: 'Prova con un esempio' },
