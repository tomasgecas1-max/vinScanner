...
const translationsMap: Record<SupportedLang, Translations> = {
  ...
  pl: {
    ...
    hero: { title: 'Poznaj historię pojazdu', titleAccent: 'według numeru VIN', desc: 'Sprawdź historię przebiegu i zapisy serwisowe w zaledwie kilka sekund. Profesjonalna weryfikacja dostępna dla każdego.', placeholder: 'Wpisz numer VIN...', button: 'Sprawdź', sample: 'Wypróbuj z przykładem' },
  ...
  fr: {
    ...
    hero: { title: 'Découvrez l\'historique du véhicule', titleAccent: 'par code VIN', desc: 'Vérifiez l\'historique du kilométrage et les enregistrements de service en quelques secondes. Vérification professionnelle accessible à tous.', placeholder: 'Entrez le numéro VIN...', button: 'Vérifier', sample: 'Essayer avec un exemple' },
  ...
  es: {
    ...
    hero: { title: 'Descubra el historial del vehículo', titleAccent: 'por código VIN', desc: 'Verifique el historial de kilometraje y los registros de servicio en solo unos segundos. Verificación profesional disponible para todos.', placeholder: 'Ingrese el número VIN...', button: 'Verificar', sample: 'Probar con un ejemplo' },
  ...
  nl: {
    ...
    hero: { title: 'Ontdek de voertuiggeschiedenis', titleAccent: 'via VIN-code', desc: 'Controleer kilometerstand en serviceregistraties in slechts een paar seconden. Professionele verificatie voor iedereen beschikbaar.', placeholder: 'Voer VIN-nummer in...', button: 'Controleren', sample: 'Probeer met een voorbeeld' },
  ...
  cs: {
    ...
    hero: { title: 'Zjistěte historii vozidla', titleAccent: 'podle VIN kódu', desc: 'Zkontrolujte historii kilometrů a servisní záznamy během několika sekund. Profesionální ověření dostupné pro každého.', placeholder: 'Zadejte číslo VIN...', button: 'Zkontrolovat', sample: 'Vyzkoušet s příkladem' },
  ...
  uk: {
    ...
    hero: { title: 'Дізнайтеся історію автомобіля', titleAccent: 'за VIN-кодом', desc: 'Перевірте історію пробігу та сервісні записи за кілька секунд. Професійна перевірка доступна кожному.', placeholder: 'Введіть номер VIN...', button: 'Перевірити', sample: 'Спробувати з прикладом' },
  ...
  ro: {
    ...
    hero: { title: 'Descoperiți istoricul vehiculului', titleAccent: 'după codul VIN', desc: 'Verificați istoricul kilometrajului și înregistrările de service în câteva secunde. Verificare profesională disponibilă pentru toți.', placeholder: 'Introduceți numărul VIN...', button: 'Verifică', sample: 'Încearcă cu un exemplu' },
  ...
  sv: {
    ...
    hero: { title: 'Upptäck fordonets historia', titleAccent: 'via VIN-kod', desc: 'Kontrollera mätarställning och serviceregister på några sekunder. Professionell verifiering tillgänglig för alla.', placeholder: 'Ange VIN-nummer...', button: 'Kontrollera', sample: 'Prova med ett exempel' },
  ...
  el: {
    ...
    hero: { title: 'Ανακαλύψτε το ιστορικό του οχήματος', titleAccent: 'με κωδικό VIN', desc: 'Ελέγξτε ιστορικό χιλιομέτρων και αρχεία service σε δευτερόλεπτα. Επαγγελματική επαλήθευση διαθέσιμη σε όλους.', placeholder: 'Εισάγετε αριθμό VIN...', button: 'Έλεγχος', sample: 'Δοκιμή με παράδειγμα' },
  ...
  pt: {
    ...
    hero: { title: 'Descubra o histórico do veículo', titleAccent: 'pelo código VIN', desc: 'Verifique histórico de quilometragem e registos de serviço em segundos. Verificação profissional disponível para todos.', placeholder: 'Digite o número VIN...', button: 'Verificar', sample: 'Testar com exemplo' },
  ...
  hu: {
    ...
    hero: { title: 'Fedezze fel a jármű történetét', titleAccent: 'VIN-kód alapján', desc: 'Ellenőrizze a kilométer-történetet és szerviznyilvántartásokat másodpercek alatt. Professzionális ellenőrzés mindenki számára.', placeholder: 'Adja meg a VIN számot...', button: 'Ellenőrzés', sample: 'Próba mintával' },
  ...
  bg: {
    ...
    hero: { title: 'Открийте историята на превозното средство', titleAccent: 'по VIN код', desc: 'Проверете история на километража и сервизни записи за секунди. Професионална проверка достъпна за всеки.', placeholder: 'Въведете VIN номер...', button: 'Провери', sample: 'Опитай с пример' },
  ...
  sr: {
    ...
    hero: { title: 'Откријте историју возила', titleAccent: 'по VIN коду', desc: 'Проверите историју километраже и сервисне записе за неколико секунди. Професионална верификација доступна свима.', placeholder: 'Унесите VIN број...', button: 'Провери', sample: 'Испробај са примером' },
  ...
  da: {
    ...
    hero: { title: 'Opdag køretøjets historik', titleAccent: 'via VIN-kode', desc: 'Tjek kilometerhistorik og serviceregistre på sekunder. Professionel verifikation tilgængelig for alle.', placeholder: 'Indtast VIN-nummer...', button: 'Tjek', sample: 'Prøv med et eksempel' },
  ...
  no: {
    ...
    hero: { title: 'Oppdag kjøretøyets historikk', titleAccent: 'via VIN-kode', desc: 'Sjekk kilometerhistorikk og serviceregistre på sekunder. Profesjonell verifisering tilgjengelig for alle.', placeholder: 'Skriv inn VIN-nummer...', button: 'Sjekk', sample: 'Prøv med et eksempel' },
    ...
    hero: { title: 'Selvitä ajoneuvon historia', titleAccent: 'VIN-koodin avulla', desc: 'Tarkista ajokilometrihistoria ja huoltorekisterit sekunneissa. Ammattimainen tarkistus kaikkien saatavilla.', placeholder: 'Syötä VIN-numero...', button: 'Tarkista', sample: 'Kokeile esimerkillä' },
  ...
  sk: {
    ...
    hero: { title: 'Zistite históriu vozidla', titleAccent: 'podľa VIN kódu', desc: 'Skontrolujte históriu kilometrov a servisné záznamy za pár sekúnd. Profesionálne overenie dostupné pre každého.', placeholder: 'Zadajte číslo VIN...', button: 'Skontrolovať', sample: 'Vyskúšať s príkladom' },
  ...
  hr: {
    ...
    hero: { title: 'Otkrijte povijest vozila', titleAccent: 'putem VIN koda', desc: 'Provjerite povijest kilometraže i servisne zapise u sekundi. Profesionalna verifikacija dostupna svima.', placeholder: 'Unesite VIN broj...', button: 'Provjeri', sample: 'Isprobaj s primjerom' },
  ...
  bs: {
    ...
    hero: { title: 'Otkrijte historiju vozila', titleAccent: 'putem VIN koda', desc: 'Provjerite historiju kilometraže i servisne zapise u sekundi. Profesionalna verifikacija dostupna svima.', placeholder: 'Unesite VIN broj...', button: 'Provjeri', sample: 'Isprobaj s primjerom' },
  ...
  sq: {
    ...
    hero: { title: 'Zbuloni historinë e automjetit', titleAccent: 'me kodin VIN', desc: 'Kontrolloni historinë e kilometrave dhe regjistrimet e servisit në sekonda. Verifikim profesional i disponueshëm për të gjithë.', placeholder: 'Shkruani numrin VIN...', button: 'Kontrollo', sample: 'Provo me shembull' },
  ...
  sl: {
    ...
    hero: { title: 'Odkrijte zgodovino vozila', titleAccent: 'po VIN kodi', desc: 'Preverite zgodovino kilometrov in servisne evidence v nekaj sekundah. Profesionalno preverjanje dostopno vsem.', placeholder: 'Vnesite VIN številko...', button: 'Preveri', sample: 'Preizkusi s primerom' },
  ...
  lv: {
    ...
    hero: { title: 'Uzziniet transportlīdzekļa vēsturi', titleAccent: 'pēc VIN koda', desc: 'Pārbaudiet nobraukuma vēsturi un apkopes ierakstus dažās sekundēs. Profesionāla pārbaude pieejama ikvienam.', placeholder: 'Ievadiet VIN numuru...', button: 'Pārbaudīt', sample: 'Izmēģināt ar piemēru' },
  ...
  mk: {
    ...
    hero: { title: 'Откријте ја историјата на возилото', titleAccent: 'по VIN код', desc: 'Проверете историја на километража и сервисни записи за неколку секунди.', placeholder: 'Внесете VIN број...', button: 'Провери', sample: 'Пробај со пример' },
  ...
  et: {
    ...
    hero: { title: 'Avastage sõiduki ajalugu', titleAccent: 'VIN-koodi järgi', desc: 'Kontrollige läbisõidu ajalugu ja teenindusregistrit sekunditega.', placeholder: 'Sisestage VIN-number...', button: 'Kontrolli', sample: 'Proovi näitega' },
  ...
  tr: {
    ...
    hero: { title: 'Araç geçmişini keşfedin', titleAccent: 'VIN koduyla', desc: 'Kilometre geçmişini ve servis kayıtlarını saniyeler içinde kontrol edin.', placeholder: 'VIN numarası girin...', button: 'Kontrol Et', sample: 'Örnekle dene' },
  ...
  ca: {
    ...
    hero: { title: 'Descobriu la història del vehicle', titleAccent: 'per codi VIN', desc: 'Comproveu la història del quilometratge i els registres de servei en segons.', placeholder: 'Introduïu el número VIN...', button: 'Comprovar', sample: 'Provar amb exemple' },
  ...
  is: {
    ...
    hero: { title: 'Uppgötvaðu sögu ökutækis', titleAccent: 'með VIN númer', desc: 'Athugaðu kílómetrasögu og þjónustuskrár á sekúndum.', placeholder: 'Sláðu inn VIN númer...', button: 'Athuga', sample: 'Prófa með dæmi' },
  ...
  lb: {
    ...
    hero: { title: 'Entdeckt d\'Geschicht vum Gefier', titleAccent: 'mat VIN Code', desc: 'Préift Kilometer a Servicerapporten a Sekonnen.', placeholder: 'VIN Nummer aginn...', button: 'Préifen', sample: 'Mat Beispill probéieren' },
  ...
  cnr: {
    ...
    hero: { title: 'Otkrijte istoriju vozila', titleAccent: 'putem VIN koda', desc: 'Provjerite kilometražu i servisne zapise.', placeholder: 'Unesite VIN...', button: 'Provjeri', sample: 'Probaj' },
  ...
  mt: {
    ...
    hero: { title: 'Skopri l-istorja tal-vettura', titleAccent: 'permezz tal-VIN', desc: 'Iċċekkja l-kilometraġġ u r-reġistri tas-servizz fi sekondi.', placeholder: 'Daħħal in-numru VIN...', button: 'Iċċekkja', sample: 'Prova b\'eżempju' },
