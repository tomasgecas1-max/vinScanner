...
const translationsMap: Record<SupportedLang, Translations> = {
  ...
  fr: {
    ...
    errors: { historyNotFound: 'Historique non trouvé.', apiFailed: 'Échec de récupération des données API. Vérifiez la clé et la connexion.', networkFailed: 'Échec de récupération des données. Vérifiez la connexion.', insufficientData: 'Données insuffisantes pour ce véhicule. Le crédit ne sera pas débité.' },
  ...
  es: {
    ...
    errors: { historyNotFound: 'No se encontró historial.', apiFailed: 'Error al obtener datos de la API. Verifique la clave y la conexión.', networkFailed: 'Error al obtener datos. Verifique la conexión.', insufficientData: 'Datos insuficientes para este vehículo. No se descontará el crédito.' },
  ...
  nl: {
    ...
    errors: { historyNotFound: 'Geschiedenis niet gevonden.', apiFailed: 'Kan geen gegevens ophalen van API. Controleer sleutel en verbinding.', networkFailed: 'Kan geen gegevens ophalen. Controleer verbinding.', insufficientData: 'Onvoldoende gegevens voor dit voertuig. Tegoed wordt niet afgeschreven.' },
  ...
  cs: {
    ...
    errors: { historyNotFound: 'Historie nebyla nalezena.', apiFailed: 'Nepodařilo se získat data z API. Zkontrolujte klíč a připojení.', networkFailed: 'Nepodařilo se získat data. Zkontrolujte připojení.', insufficientData: 'Nedostatečné údaje pro toto vozidlo. Kredit nebude odečten.' },
  ...
  uk: {
    ...
    errors: { historyNotFound: 'Історію не знайдено.', apiFailed: 'Не вдалося отримати дані з API. Перевірте ключ та з\'єднання.', networkFailed: 'Не вдалося отримати дані. Перевірте з\'єднання.', insufficientData: 'Недостатньо даних для цього автомобіля. Кредит не буде списано.' },
  ...
  ro: {
    ...
    errors: { historyNotFound: 'Istoricul nu a fost găsit.', apiFailed: 'Nu s-au putut obține date din API. Verificați cheia și conexiunea.', networkFailed: 'Nu s-au putut obține date. Verificați conexiunea.', insufficientData: 'Date insuficiente pentru acest vehicul. Creditul nu va fi dedus.' },
  ...
  sv: {
    ...
    errors: { historyNotFound: 'Historik hittades inte.', apiFailed: 'Kunde inte hämta data från API. Kontrollera nyckel och anslutning.', networkFailed: 'Kunde inte hämta data. Kontrollera anslutningen.', insufficientData: 'Otillräcklig data för detta fordon. Krediten dras inte av.' },
  ...
  el: {
    ...
    errors: { historyNotFound: 'Το ιστορικό δεν βρέθηκε.', apiFailed: 'Αποτυχία λήψης δεδομένων από API. Ελέγξτε κλειδί και σύνδεση.', networkFailed: 'Αποτυχία λήψης δεδομένων. Ελέγξτε σύνδεση.', insufficientData: 'Ανεπαρκή δεδομένα για αυτό το όχημα. Η πίστωση δεν θα αφαιρεθεί.' },
  ...
  pt: {
    ...
    errors: { historyNotFound: 'Histórico não encontrado.', apiFailed: 'Falha ao obter dados da API. Verifique a chave e conexão.', networkFailed: 'Falha ao obter dados. Verifique a conexão.', insufficientData: 'Dados insuficientes para este veículo. O crédito não será deduzido.' },
  ...
  hu: {
    ...
    errors: { historyNotFound: 'A történet nem található.', apiFailed: 'Nem sikerült adatokat lekérni az API-ból. Ellenőrizze a kulcsot és a kapcsolatot.', networkFailed: 'Nem sikerült adatokat lekérni. Ellenőrizze a kapcsolatot.', insufficientData: 'Elégtelen adat ehhez a járműhöz. A kredit nem kerül levonásra.' },
  ...
  bg: {
    ...
    errors: { historyNotFound: 'Историята не е намерена.', apiFailed: 'Неуспешно получаване на данни от API. Проверете ключа и връзката.', networkFailed: 'Неуспешно получаване на данни. Проверете връзката.', insufficientData: 'Недостатъчни данни за това превозно средство. Кредитът няма да бъде удържан.' },
  ...
  sr: {
    ...
    errors: { historyNotFound: 'Историја није пронађена.', apiFailed: 'Није успело преузимање података из API-ја. Проверите кључ и везу.', networkFailed: 'Није успело преузимање података. Проверите везу.', insufficientData: 'Недовољно података за ово возило. Кредит неће бити одузет.' },
  ...
  da: {
    ...
    errors: { historyNotFound: 'Historik ikke fundet.', apiFailed: 'Kunne ikke hente data fra API. Tjek nøgle og forbindelse.', networkFailed: 'Kunne ikke hente data. Tjek forbindelsen.', insufficientData: 'Utilstrækkelige data for dette køretøj. Kredit vil ikke blive fratrukket.' },
  ...
  no: {
    ...
    errors: { historyNotFound: 'Historikk ikke funnet.', apiFailed: 'Kunne ikke hente data fra API. Sjekk nøkkel og tilkobling.', networkFailed: 'Kunne ikke hente data. Sjekk tilkoblingen.', insufficientData: 'Utilstrekkelige data for dette kjøretøyet. Kreditt vil ikke bli trukket.' },
    ...
    errors: { historyNotFound: 'Historiaa ei löytynyt.', apiFailed: 'Tietojen haku API:sta epäonnistui. Tarkista avain ja yhteys.', networkFailed: 'Tietojen haku epäonnistui. Tarkista yhteys.', insufficientData: 'Riittämättömät tiedot tälle ajoneuvolle. Krediittiä ei veloiteta.' },
  ...
  sk: {
    ...
    errors: { historyNotFound: 'História nebola nájdená.', apiFailed: 'Nepodarilo sa získať dáta z API. Skontrolujte kľúč a pripojenie.', networkFailed: 'Nepodarilo sa získať dáta. Skontrolujte pripojenie.', insufficientData: 'Nedostatočné údaje pre toto vozidlo. Kredit nebude odpočítaný.' },
  ...
  hr: {
    ...
    errors: { historyNotFound: 'Povijest nije pronađena.', apiFailed: 'Nije uspjelo dohvaćanje podataka iz API-ja. Provjerite ključ i vezu.', networkFailed: 'Nije uspjelo dohvaćanje podataka. Provjerite vezu.', insufficientData: 'Nedovoljno podataka za ovo vozilo. Kredit neće biti oduzet.' },
  ...
  bs: {
    ...
    errors: { historyNotFound: 'Historija nije pronađena.', apiFailed: 'Nije uspjelo dohvatanje podataka iz API-ja. Provjerite ključ i vezu.', networkFailed: 'Nije uspjelo dohvatanje podataka. Provjerite vezu.', insufficientData: 'Nedovoljno podataka za ovo vozilo. Kredit neće biti oduzet.' },
  ...
  sq: {
    ...
    errors: { historyNotFound: 'Historia nuk u gjet.', apiFailed: 'Marrja e të dhënave nga API dështoi.', networkFailed: 'Marrja e të dhënave dështoi. Kontrolloni lidhjen.', insufficientData: 'Të dhëna të pamjaftueshme për këtë automjet. Krediti nuk do të zbritet.' },
  ...
  sl: {
    ...
    errors: { historyNotFound: 'Zgodovina ni bila najdena.', apiFailed: 'Pridobivanje podatkov iz API ni uspelo.', networkFailed: 'Pridobivanje podatkov ni uspelo. Preverite povezavo.', insufficientData: 'Nezadostni podatki za to vozilo. Kredit ne bo odštet.' },
  ...
  lv: {
    ...
    errors: { historyNotFound: 'Vēsture netika atrasta.', apiFailed: 'Neizdevās iegūt datus no API.', networkFailed: 'Neizdevās iegūt datus. Pārbaudiet savienojumu.', insufficientData: 'Nepietiekami dati par šo transportlīdzekli. Kredīts netiks noņemts.' },
  ...
  mk: {
    ...
    errors: { historyNotFound: 'Историјата не е пронајдена.', apiFailed: 'API грешка.', networkFailed: 'Мрежна грешка.', insufficientData: 'Недоволно податоци за ова возило. Кредитот нема да биде одземен.' },
  ...
  et: {
    ...
    errors: { historyNotFound: 'Ajalugu ei leitud.', apiFailed: 'API viga.', networkFailed: 'Võrguviga.', insufficientData: 'Selle sõiduki kohta pole piisavalt andmeid. Krediiti ei arvestata maha.' },
  ...
  tr: {
    ...
    errors: { historyNotFound: 'Geçmiş bulunamadı.', apiFailed: 'API hatası.', networkFailed: 'Ağ hatası.', insufficientData: 'Bu araç için yetersiz veri. Kredi düşülmeyecek.' },
  ...
  ca: {
    ...
    errors: { historyNotFound: 'Història no trobada.', apiFailed: 'Error API.', networkFailed: 'Error de xarxa.', insufficientData: 'Dades insuficients per a aquest vehicle. El crèdit no es descomptarà.' },
  ...
  is: {
    ...
    errors: { historyNotFound: 'Saga fannst ekki.', apiFailed: 'API villa.', networkFailed: 'Netvilla.', insufficientData: 'Ófullnægjandi gögn fyrir þetta ökutæki. Inneign verður ekki dregin frá.' },
  ...
  lb: {
    ...
    errors: { historyNotFound: 'Geschicht net fonnt.', apiFailed: 'API Feeler.', networkFailed: 'Netzwierk Feeler.', insufficientData: 'Net genuch Daten fir dëst Gefier. Kredit gëtt net ofgezunn.' },
  ...
  cnr: {
    ...
    errors: { historyNotFound: 'Nije pronađeno.', apiFailed: 'API greška.', networkFailed: 'Mrežna greška.', insufficientData: 'Nedovoljno podataka za ovo vozilo. Kredit neće biti oduzet.' },
  ...
  mt: {
    ...
    errors: { historyNotFound: 'Storja ma nstabitx.', apiFailed: 'Żball API.', networkFailed: 'Żball tan-netwerk.', insufficientData: 'Dejta mhux biżżejjed għal dan il-vettura. Il-kreditu mhux se jitnaqqas.' },
