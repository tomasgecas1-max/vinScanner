...
const translationsMap: Record<SupportedLang, Translations> = {
  ...
  pl: {
    ...
    errors: { historyNotFound: 'Historia nie została znaleziona.', apiFailed: 'Nie udało się pobrać danych z API. Sprawdź klucz i połączenie.', networkFailed: 'Nie udało się pobrać danych. Sprawdź połączenie.', insufficientData: 'Niewystarczające dane dla tego pojazdu. Kredyt nie zostanie pobrany.', insufficientDataTitle: 'Nie znaleziono danych' },
  ...
  fr: {
    ...
    errors: { historyNotFound: 'Historique non trouvé.', apiFailed: 'Échec de récupération des données API. Vérifiez la clé et la connexion.', networkFailed: 'Échec de récupération des données. Vérifiez la connexion.', insufficientData: 'Données insuffisantes pour ce véhicule. Le crédit ne sera pas débité.', insufficientDataTitle: 'Données non trouvées' },
  ...
  es: {
    ...
    errors: { historyNotFound: 'No se encontró historial.', apiFailed: 'Error al obtener datos de la API. Verifique la clave y la conexión.', networkFailed: 'Error al obtener datos. Verifique la conexión.', insufficientData: 'Datos insuficientes para este vehículo. No se descontará el crédito.', insufficientDataTitle: 'Datos no encontrados' },
  ...
  it: {
    ...
    errors: { historyNotFound: 'Storico non trovato.', apiFailed: 'Impossibile ottenere dati dall\'API. Controlla la chiave e la connessione.', networkFailed: 'Impossibile ottenere dati. Controlla la connessione.', insufficientData: 'Dati insufficienti per questo veicolo. Il credito non verrà detratto.', insufficientDataTitle: 'Dati non trovati' },
  ...
  cs: {
    ...
    errors: { historyNotFound: 'Historie nebyla nalezena.', apiFailed: 'Nepodařilo se získat data z API. Zkontrolujte klíč a připojení.', networkFailed: 'Nepodařilo se získat data. Zkontrolujte připojení.', insufficientData: 'Nedostatečné údaje pro toto vozidlo. Kredit nebude odečten.', insufficientDataTitle: 'Data nenalezena' },
  ...
  uk: {
    ...
    errors: { historyNotFound: 'Історію не знайдено.', apiFailed: 'Не вдалося отримати дані з API. Перевірте ключ та з\'єднання.', networkFailed: 'Не вдалося отримати дані. Перевірте з\'єднання.', insufficientData: 'Недостатньо даних для цього автомобіля. Кредит не буде списано.', insufficientDataTitle: 'Даних не знайдено' },
  ...
  sv: {
    ...
    errors: { historyNotFound: 'Historik hittades inte.', apiFailed: 'Kunde inte hämta data från API. Kontrollera nyckel och anslutning.', networkFailed: 'Kunde inte hämta data. Kontrollera anslutningen.', insufficientData: 'Otillräcklig data för detta fordon. Krediten dras inte av.', insufficientDataTitle: 'Data hittades inte' },
  ...
  el: {
    ...
    errors: { historyNotFound: 'Το ιστορικό δεν βρέθηκε.', apiFailed: 'Αποτυχία λήψης δεδομένων από API. Ελέγξτε κλειδί και σύνδεση.', networkFailed: 'Αποτυχία λήψης δεδομένων. Ελέγξτε σύνδεση.', insufficientData: 'Ανεπαρκή δεδομένα για αυτό το όχημα. Η πίστωση δεν θα αφαιρεθεί.', insufficientDataTitle: 'Δεδομένα δεν βρέθηκαν' },
  ...
  pt: {
    ...
    errors: { historyNotFound: 'Histórico não encontrado.', apiFailed: 'Falha ao obter dados da API. Verifique a chave e conexão.', networkFailed: 'Falha ao obter dados. Verifique a conexão.', insufficientData: 'Dados insuficientes para este veículo. O crédito não será deduzido.', insufficientDataTitle: 'Dados não encontrados' },
  ...
  hu: {
    ...
    errors: { historyNotFound: 'A történet nem található.', apiFailed: 'Nem sikerült adatokat lekérni az API-ból. Ellenőrizze a kulcsot és a kapcsolatot.', networkFailed: 'Nem sikerült adatokat lekérni. Ellenőrizze a kapcsolatot.', insufficientData: 'Elégtelen adat ehhez a járműhöz. A kredit nem kerül levonásra.', insufficientDataTitle: 'Adatok nem találhatók' },
  ...
  bg: {
    ...
    errors: { historyNotFound: 'Историята не е намерена.', apiFailed: 'Неуспешно получаване на данни от API. Проверете ключа и връзката.', networkFailed: 'Неуспешно получаване на данни. Проверете връзката.', insufficientData: 'Недостатъчни данни за това превозно средство. Кредитът няма да бъде удържан.', insufficientDataTitle: 'Данните не са намерени' },
  ...
  sr: {
    ...
    errors: { historyNotFound: 'Историја није пронађена.', apiFailed: 'Није успело преузимање података из API-ја. Проверите кључ и везу.', networkFailed: 'Није успело преузимање података. Проверите везу.', insufficientData: 'Недовољно података за ово возило. Кредит неће бити одузет.', insufficientDataTitle: 'Подаци нису пронађени' },
  ...
  da: {
    ...
    errors: { historyNotFound: 'Historik ikke fundet.', apiFailed: 'Kunne ikke hente data fra API. Tjek nøgle og forbindelse.', networkFailed: 'Kunne ikke hente data. Tjek forbindelsen.', insufficientData: 'Utilstrækkelige data for dette køretøj. Kredit vil ikke blive fratrukket.', insufficientDataTitle: 'Data ikke fundet' },
  ...
  no: {
    ...
    errors: { historyNotFound: 'Historikk ikke funnet.', apiFailed: 'Kunne ikke hente data fra API. Sjekk nøkkel og tilkobling.', networkFailed: 'Kunne ikke hente data. Sjekk tilkoblingen.', insufficientData: 'Utilstrekkelige data for dette kjøretøyet. Kreditt vil ikke bli trukket.', insufficientDataTitle: 'Data ikke funnet' },
    ...
    errors: { historyNotFound: 'Historiaa ei löytynyt.', apiFailed: 'Tietojen haku API:sta epäonnistui. Tarkista avain ja yhteys.', networkFailed: 'Tietojen haku epäonnistui. Tarkista yhteys.', insufficientData: 'Riittämättömät tiedot tälle ajoneuvolle. Krediittiä ei veloiteta.', insufficientDataTitle: 'Tietoja ei löytynyt' },
  ...
  sk: {
    ...
    errors: { historyNotFound: 'História nebola nájdená.', apiFailed: 'Nepodarilo sa získať dáta z API. Skontrolujte kľúč a pripojenie.', networkFailed: 'Nepodarilo sa získať dáta. Skontrolujte pripojenie.', insufficientData: 'Nedostatočné údaje pre toto vozidlo. Kredit nebude odpočítaný.', insufficientDataTitle: 'Údaje nenájdené' },
  ...
  hr: {
    ...
    errors: { historyNotFound: 'Povijest nije pronađena.', apiFailed: 'Nije uspjelo dohvaćanje podataka iz API-ja. Provjerite ključ i vezu.', networkFailed: 'Nije uspjelo dohvaćanje podataka. Provjerite vezu.', insufficientData: 'Nedovoljno podataka za ovo vozilo. Kredit neće biti oduzet.', insufficientDataTitle: 'Podaci nisu pronađeni' },
  ...
  bs: {
    ...
    errors: { historyNotFound: 'Historija nije pronađena.', apiFailed: 'Nije uspjelo dohvatanje podataka iz API-ja. Provjerite ključ i vezu.', networkFailed: 'Nije uspjelo dohvatanje podataka. Provjerite vezu.', insufficientData: 'Nedovoljno podataka za ovo vozilo. Kredit neće biti oduzet.', insufficientDataTitle: 'Podaci nisu pronađeni' },
  ...
  sq: {
    ...
    errors: { historyNotFound: 'Historia nuk u gjet.', apiFailed: 'Marrja e të dhënave nga API dështoi.', networkFailed: 'Marrja e të dhënave dështoi. Kontrolloni lidhjen.', insufficientData: 'Të dhëna të pamjaftueshme për këtë automjet. Krediti nuk do të zbritet.', insufficientDataTitle: 'Të dhënat nuk u gjetën' },
  ...
  sl: {
    ...
    errors: { historyNotFound: 'Zgodovina ni bila najdena.', apiFailed: 'Pridobivanje podatkov iz API ni uspelo.', networkFailed: 'Pridobivanje podatkov ni uspelo. Preverite povezavo.', insufficientData: 'Nezadostni podatki za to vozilo. Kredit ne bo odštet.', insufficientDataTitle: 'Podatki niso najdeni' },
  ...
  lv: {
    ...
    errors: { historyNotFound: 'Vēsture netika atrasta.', apiFailed: 'Neizdevās iegūt datus no API.', networkFailed: 'Neizdevās iegūt datus. Pārbaudiet savienojumu.', insufficientData: 'Nepietiekami dati par šo transportlīdzekli. Kredīts netiks noņemts.', insufficientDataTitle: 'Dati nav atrasti' },
  ...
  mk: {
    ...
    errors: { historyNotFound: 'Историјата не е пронајдена.', apiFailed: 'API грешка.', networkFailed: 'Мрежна грешка.', insufficientData: 'Недоволно податоци за ова возило. Кредитот нема да биде одземен.', insufficientDataTitle: 'Податоците не се пронајдени' },
  ...
  et: {
    ...
    errors: { historyNotFound: 'Ajalugu ei leitud.', apiFailed: 'API viga.', networkFailed: 'Võrguviga.', insufficientData: 'Selle sõiduki kohta pole piisavalt andmeid. Krediiti ei arvestata maha.', insufficientDataTitle: 'Andmeid ei leitud' },
  ...
  tr: {
    ...
    errors: { historyNotFound: 'Geçmiş bulunamadı.', apiFailed: 'API hatası.', networkFailed: 'Ağ hatası.', insufficientData: 'Bu araç için yetersiz veri. Kredi düşülmeyecek.', insufficientDataTitle: 'Veri bulunamadı' },
  ...
  ca: {
    ...
    errors: { historyNotFound: 'Història no trobada.', apiFailed: 'Error API.', networkFailed: 'Error de xarxa.', insufficientData: 'Dades insuficients per a aquest vehicle. El crèdit no es descomptarà.', insufficientDataTitle: 'Dades no trobades' },
  ...
  is: {
    ...
    errors: { historyNotFound: 'Saga fannst ekki.', apiFailed: 'API villa.', networkFailed: 'Netvilla.', insufficientData: 'Ófullnægjandi gögn fyrir þetta ökutæki. Inneign verður ekki dregin frá.', insufficientDataTitle: 'Gögn fundust ekki' },
  ...
  lb: {
    ...
    errors: { historyNotFound: 'Geschicht net fonnt.', apiFailed: 'API Feeler.', networkFailed: 'Netzwierk Feeler.', insufficientData: 'Net genuch Daten fir dëst Gefier. Kredit gëtt net ofgezunn.', insufficientDataTitle: 'Daten net fonnt' },
    ...
    auth: { title: 'Aloggen', subtitle: 'Wielt wéi Dir wëllt weidermaachen', googleButton: 'Mat Google weidermaachen', emailButton: 'Mat E-Mail weidermaachen', continueWithout: 'Ouni Aloggen weidermaachen', or: 'oder', noAccountYet: 'Keen Kont?', createAccount: 'Erstellt een', alreadyHaveAccount: 'Hutt Dir schonn e Kont?', signIn: 'Aloggen', back: 'Zréck', loginTitle: 'Mat E-Mail aloggen', registerTitle: 'Kont erstellen', resetTitle: 'Passwuert zrécksetzen', resetSubtitle: 'Gitt Är E-Mail an a mir schécken Iech e Resetlink', emailLabel: 'E-Mail', passwordLabel: 'Passwuert', confirmPasswordLabel: 'Passwuert bestätegen', loginButton: 'Aloggen', registerButton: 'Kont erstellen', resetButton: 'Resetlink schécken', forgotPassword: 'Passwuert vergiess?', googleError: 'Google Aloggen huet net fonctionnéiert', loginError: 'Aloggen huet net fonctionnéiert', registerError: 'Registréierung huet net fonctionnéiert', resetError: 'Konnt Reset E-Mail net schécken', resetSent: 'Passwuert Reset E-Mail geschéckt', passwordMismatch: 'Passwierder stëmmen net iwweran', passwordTooShort: 'Passwuert muss op d\'mannst 6 Zeechen hunn' },
  },
  cnr: {
    seo: {
    ...
    errors: { historyNotFound: 'Nije pronađeno.', apiFailed: 'API greška.', networkFailed: 'Mrežna greška.', insufficientData: 'Nedovoljno podataka za ovo vozilo. Kredit neće biti oduzet.', insufficientDataTitle: 'Podaci nisu pronađeni' },
    ...
    auth: { title: 'Prijava', subtitle: 'Izaberite kako želite nastaviti', googleButton: 'Nastavite s Googleom', emailButton: 'Nastavite s emailom', continueWithout: 'Nastavite bez prijave', or: 'ili', noAccountYet: 'Nemate nalog?', createAccount: 'Napravite jedan', alreadyHaveAccount: 'Već imate nalog?', signIn: 'Prijavite se', back: 'Nazad', loginTitle: 'Prijava s emailom', registerTitle: 'Kreiranje naloga', resetTitle: 'Resetovanje lozinke', resetSubtitle: 'Unesite vaš email i poslaćemo vam link za resetovanje', emailLabel: 'Email', passwordLabel: 'Lozinka', confirmPasswordLabel: 'Potvrdite lozinku', loginButton: 'Prijava', registerButton: 'Kreiraj nalog', resetButton: 'Pošalji link za resetovanje', forgotPassword: 'Zaboravili ste lozinku?', googleError: 'Google prijava nije uspjela', loginError: 'Prijava nije uspjela', registerError: 'Registracija nije uspjela', resetError: 'Slanje emaila za resetovanje nije uspjelo', resetSent: 'Email za resetovanje lozinke je poslan', passwordMismatch: 'Lozinke se ne podudaraju', passwordTooShort: 'Lozinka mora imati najmanje 6 karaktera' },
  },
  mt: {
    seo: {
    ...
    errors: { historyNotFound: 'Storja ma nstabitx.', apiFailed: 'Żball API.', networkFailed: 'Żball tan-netwerk.', insufficientData: 'Dejta mhux biżżejjed għal dan il-vettura. Il-kreditu mhux se jitnaqqas.', insufficientDataTitle: 'Dejta ma nstabitx' },
